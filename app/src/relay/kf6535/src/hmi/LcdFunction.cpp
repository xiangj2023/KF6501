...
{		
	char DlgCaption[64];
	sprintf(DlgCaption, tr("一次侧保护值\n"));
	WORD whAIIndex[] = {RM_UA,RM_UB,RM_UC,RM_UAB,RM_UBC,RM_UCA,RM_U2H,RM_U0,RM_IHA,RM_IHB,RM_IHC,RM_IMA,RM_IMB,RM_IMC,RM_ILA,RM_ILB,RM_ILC,RM_I0,RM_IJX};	
	g_AIDlg.DoModal(this, this, phAI,19,whAIIndex,DlgCaption);
}
...
void CLcdWndMeasure::OnEnterBtnPML()
{
	...
	WORD whAIIndex[] = {RM_UA,RM_UB,RM_UC,RM_UAB,RM_UBC,RM_UCA,RM_U2H,RM_U0,RM_IHA,RM_IHB,RM_IHC,RM_IMA,RM_IMB,RM_IMC,RM_ILA,RM_ILB,\
		RM_ILC,RM_I0,RM_IJX,RM_IDA,RM_IDB,RM_IDC,RM_IRA,RM_IRB,RM_IRC,RM_IDA2,RM_IDA3,RM_IDA5,RM_IDB2,RM_IDB3,RM_IDB5,RM_IDC2,RM_IDC3,RM_IDC5,\
		RM_IRA2,RM_IRB2,RM_IRC2,RM_AUA,RM_AUB,RM_AUC,RM_AIHA,RM_AIHB,RM_AIHC,RM_AIMA,RM_AIMB,RM_AIMC,RM_AILA,RM_AILB,RM_AILC};	
	g_AIDlg.DoModal(this, this, plAI,49,whAIIndex,DlgCaption);
}
void CLcdWndMeasure::OnEnterBtnHMe()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("一次侧测量值\n"));
	WORD whAIIndex[] = {M_UA,M_UB,M_UC,M_U0,M_IHAM,M_IHBM,M_IHCM,M_IMAM,M_IMBM,M_IMCM,M_ILAM,M_ILBM,M_ILCM,M_I0M,M_IJXM};	
	g_AIDlg.DoModal(this, this, hAI,15,whAIIndex,DlgCaption);
}

void CLcdWndMeasure::OnEnterBtnLMe()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("二次侧测量值\n"));
	WORD whAIIndex[] = {M_UA,M_UB,M_UC,M_U0,M_IHAM,M_IHBM,M_IHCM,M_IMAM,M_IMBM,M_IMCM,M_ILAM,M_ILBM,M_ILCM,M_I0M,M_IJXM};	
	g_AIDlg.DoModal(this, this, lAI,15,whAIIndex,DlgCaption);
}
...
BOOL CLcdWndSettingModify::OnWndInit()
{
	...
	if (wSetNameCount>0) //combo
	{
		...
		m_ComboSettingComb.m_nXSize = 210;//m_EditSettingData.m_nXSize;
