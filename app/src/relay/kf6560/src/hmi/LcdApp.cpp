...
BOOL CLcdWndMainMenu::Init()
{
	...
	SetCaption(tr("KF6560电铁并补保护测控装置"));
	SetEscWnd(NULL);
	SetEnterWnd(NULL);
	SetUDFun(0);
	SetUDOffset(2);
	...
	m_BtnAbout.SetPosition(15,74,110,109,1);
...
BOOL CLcdWndMeasure::Init()
{
	...
	m_BtnPML.SetPosition(21,92,216,117,0);
	...
	m_BtnMHarmonic.SetPosition(21,124,216,149,0);
	m_BtnMHarmonic.SetTabOrder(4);
	m_pObjList[4] = &m_BtnMHarmonic;
	m_BtnMHarmonic.SetFont(16);
	m_BtnMHarmonic.SetOwner(this);
	m_BtnMHarmonic.SetCaption(tr("二次侧谐波值"));
	m_BtnMHarmonic.SetHaveEnterFun(TRUE);
	m_BtnMHarmonic.SetEnterWnd(NULL);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(4);
...
//{{HMI_MSG_MAP(CLcdWndMeasure)
	...
	ON_HMIBTN_ENTER(4, OnEnterBtnMHarmonic)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndASModify::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditAsInput.SetPosition(102,37,187,57,0);
	...
	m_StaticASSymbol.SetPosition(14,37,94,52,0);
	...
	m_StaticAsUnit.SetPosition(195,37,230,52,0);
	...
	m_StaticDownLimit.SetPosition(14,111,164,126,0);
	...
	m_StaticUpLimit.SetPosition(14,134,184,149,0);
...
BOOL CLcdWndReport::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnActionReport.SetPosition(24,28,219,53,0);
	...
	m_BtnAlarmReport.SetPosition(24,61,219,86,0);
	...
	m_BtnStartReport.SetPosition(24,94,219,119,0);
	...
	m_BtnSoe.SetPosition(24,127,219,152,0);
	...
	m_BtnOperation.SetPosition(24,27,219,52,1);
...
BOOL CLcdWndSettingQueryAreaNumInput::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditAreaNum.SetPosition(178,80,208,100,0);
	...
	m_Static4883.SetPosition(22,80,167,100,0);
	...
	m_Static4915.SetPosition(22,44,167,64,0);
...
BOOL CLcdWndSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSettingQuery.SetPosition(17,28,222,53,0);
	...
	m_BtnsettingModify.SetPosition(17,61,222,86,0);
	...
	m_BtnSettingCopy.SetPosition(17,94,222,119,0);
	...
	m_BtnsettingExChg.SetPosition(17,127,222,152,0);
	...
	m_BtnASQuery.SetPosition(17,29,222,54,1);
	...
	m_BtnASModify.SetPosition(17,62,222,87,1);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnAdress.SetPosition(22,28,217,53,0);
	...
	m_BtnInputSetting.SetPosition(22,61,217,86,0);
	...
	m_BtnBOTime.SetPosition(22,94,217,119,0);
	...
	m_BtnDeviceTime.SetPosition(22,127,217,152,0);
	...
	m_BtnLanguage.SetPosition(22,31,217,56,1);
	m_BtnLanguage.SetTabOrder(5);
	m_pObjList[5] = &m_BtnLanguage;
	m_BtnLanguage.SetFont(0);
	...
	m_BtnPassSetting.SetPosition(22,64,217,89,1);
	...
	m_BtnSysParam.SetPosition(22,97,217,122,1);
	m_BtnSysParam.SetTabOrder(7);
	m_pObjList[7] = &m_BtnSysParam;
	m_BtnSysParam.SetFont(16);
...
BOOL CLcdWndtime::Init()
{
	...
	m_EditHour.SetPosition(26,115,66,135,0);
	...
	m_EditMinute.SetPosition(93,115,133,135,0);
	...
	m_EditSecond.SetPosition(161,115,201,135,0);
	...
	m_Static4739.SetPosition(26,89,66,109,0);
	...
	m_Static4740.SetPosition(93,89,133,109,0);
	...
	m_Static4741.SetPosition(161,89,201,109,0);
...
BOOL CLcdWndInputSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSoeProperty.SetPosition(17,33,217,58,0);
	...
	m_BtnBIFilter.SetPosition(17,64,217,89,0);
	...
	m_BtnBiNo.SetPosition(17,95,217,120,0);
...
BOOL CLcdWndTest::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnOutputTest.SetPosition(21,28,216,53,0);
	...
	m_BtnLenTest.SetPosition(21,61,216,86,0);
	...
	m_BtnReportTest.SetPosition(21,94,216,119,0);
	...
	m_BtnManualREC.SetPosition(21,127,216,152,0);
	...
	m_BtnfactorySet.SetPosition(21,28,216,53,1);
...
BOOL CLcdWndOutputTest::Init()
{
	...
	m_EditOutputNum.SetValueRange(7,1);
...
BOOL CLcdWndAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnCAN.SetPosition(21,28,221,53,0);
	...
	m_BtnETH.SetPosition(21,58,221,83,0);
	...
	m_BtnPortPara.SetPosition(21,88,221,113,0);
	...
	m_BtnSerialset.SetPosition(21,117,221,142,0);
...
BOOL CLcdWndEthadd::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnetha.SetPosition(22,34,212,59,0);
	...
	m_Btnethb.SetPosition(22,66,212,91,0);
...
BOOL CLcdWndCANAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnenter.SetPosition(42,109,102,134,0);
	...
	m_BtnESC.SetPosition(135,109,195,134,0);
	...
	m_EditCANA.SetPosition(102,40,147,65,0);
	...
	m_Static5447.SetPosition(21,45,101,70,0);
	m_Static5447.SetTabOrder(-4);
	m_pObjList[4] = &m_Static5447;
	m_Static5447.SetFont(16);
	m_Static5447.SetOwner(this);
	m_Static5447.SetCaption(tr("装置地址:"));
	m_Static5447.SetDataSource(-1,0);
	m_Static5447.SetTimer(0);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(4);
...
BOOL CLcdWndPassChange::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnChgCommonPass.SetPosition(17,35,222,60,0);
	...
	m_BtnChgSettingPass.SetPosition(17,69,222,94,0);
...
BOOL CLcdWndsyspara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnContrast.SetPosition(17,28,222,53,0);
	...
	m_BtnFVDH.SetPosition(17,60,222,85,0);
	...
	m_BtnIRGBType.SetPosition(17,97,222,122,0);
	...
	m_BtnModifyEEPROM.SetPosition(17,131,222,156,0);
	m_BtnModifyEEPROM.SetTabOrder(4);
	m_pObjList[4] = &m_BtnModifyEEPROM;
	m_BtnModifyEEPROM.SetFont(16);
	m_BtnModifyEEPROM.SetOwner(this);
	m_BtnModifyEEPROM.SetCaption(tr("恢复出厂设置"));
	m_BtnModifyEEPROM.SetHaveEnterFun(TRUE);
	m_BtnModifyEEPROM.SetEnterWnd(NULL);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(4);
...
//{{HMI_MSG_MAP(CLcdWndsyspara)
	...
	ON_HMIBTN_ENTER(4, OnEnterBtnModifyEEPROM)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(40,30,200,55,0);
...
BOOL CLcdWndWStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDevStatus.SetPosition(25,35,220,60,0);
	...
	m_BtnComStatus.SetPosition(25,68,220,93,0);
