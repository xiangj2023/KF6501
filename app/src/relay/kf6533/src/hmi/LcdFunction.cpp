...
{		
	...
	WORD whAIIndex[] = {M_UHA,M_UHB,M_UHC,M_U0H,M_ULA,M_ULB,M_ULC,M_U0L,M_IHA,M_IHB,M_IHC,M_ILA,M_ILB,M_ILC, \
		M_I0,M_IJX};	
	g_AIDlg.DoModal(this, this, hAI,16,whAIIndex,DlgCaption);
}
...
{	
	...
	WORD whAIIndex[] = {M_UHA,M_UHB,M_UHC,M_U0H,M_ULA,M_ULB,M_ULC,M_U0L,M_IHA,M_IHB,M_IHC,M_ILA,M_ILB,M_ILC, \
		M_I0,M_IJX};	
	g_AIDlg.DoModal(this, this, lAI,16,whAIIndex,DlgCaption);
}
void CLcdWndMeasure::OnEnterBtnPML87()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("差动保护值\n"));		
	WORD wplAIIndex[] = {RM_IDA,RM_IDB,RM_IDC,RM_IRA,RM_IRB,RM_IRC,RM_IDA2,RM_IDA3,RM_IDB2,RM_IDB3,\
		RM_IDC2,RM_IDC3,RM_IRA2,RM_IRB2,RM_IRC2};	
	g_AIDlg.DoModal(this, this, plAI,15,wplAIIndex,DlgCaption);	
}

void CLcdWndMeasure::OnEnterBtnPML50()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("后备保护值\n"));		
	WORD wplAIIndex[] = {RM_UHA,RM_UHB,RM_UHC,RM_UAB,RM_UBC,RM_UCA,RM_U0H,RM_ULA,RM_ULB,RM_ULC,RM_U0L,RM_IHA,RM_IHB,RM_IHC,RM_ILA,\
		RM_ILB,RM_ILC,RM_I0,RM_IJX,RM_U2H,RM_U2L};	
	g_AIDlg.DoModal(this, this, plAI,21,wplAIIndex,DlgCaption);	
}
...
void CLcdWndMeasure::OnEnterBtnUIAngle()
{
	...
	WORD wlAIIndex[] = {RM_AUHA,RM_AUHB,RM_AUHC,RM_AULA,RM_AULB,RM_AULC,RM_AIHA,RM_AIHB,RM_AIHC,RM_AILA,\
		RM_AILB,RM_AILC}; 
	g_AIDlg.DoModal(this, this, plAI,12,wlAIIndex,DlgCaption);
}
