...
BOOL CLcdWndMainMenu::Init()
{
	...
	SetCaption(tr("KF6533电力变压器保护测控装置"));
	SetEscWnd(NULL);
	SetEnterWnd(NULL);
	SetUDFun(0);
	SetUDOffset(2);
	...
	m_BtnMeasure.SetPosition(16,30,111,65,0);
	...
	m_BtnSetting.SetPosition(125,30,220,65,0);
	...
	m_BtnInput.SetPosition(16,73,111,108,0);
	...
	m_BtnSoftSwitch.SetPosition(125,73,220,108,0);
	...
	m_BtnReport.SetPosition(16,116,111,151,0);
	...
	m_BtnSystem.SetPosition(125,116,220,151,0);
	...
	m_BtnStatus.SetPosition(124,31,219,66,1);
	...
	m_BtnAbout.SetPosition(14,81,109,116,1);
...
BOOL CLcdWndMeasure::Init()
{
	...
	m_BtnLMeasure.SetPosition(21,60,216,85,0);
	...
	m_BtnPML87.SetPosition(21,93,216,118,0);
	m_BtnPML87.SetTabOrder(3);
	m_pObjList[3] = &m_BtnPML87;
	m_BtnPML87.SetFont(0);
	m_BtnPML87.SetOwner(this);
	m_BtnPML87.SetCaption(tr("差动保护值"));
	m_BtnPML87.SetHaveEnterFun(TRUE);
	m_BtnPML87.SetEnterWnd(NULL);
	m_BtnPML50.SetPosition(21,126,216,151,0);
	m_BtnPML50.SetTabOrder(4);
	m_pObjList[4] = &m_BtnPML50;
	m_BtnPML50.SetFont(16);
	m_BtnPML50.SetOwner(this);
	m_BtnPML50.SetCaption(tr("后备保护值"));
	m_BtnPML50.SetHaveEnterFun(TRUE);
	m_BtnPML50.SetEnterWnd(NULL);
	m_BtnUIAngle.SetPosition(21,29,216,54,1);
	m_BtnUIAngle.SetTabOrder(5);
	m_pObjList[5] = &m_BtnUIAngle;
...
//{{HMI_MSG_MAP(CLcdWndMeasure)
	...
	ON_HMIBTN_ENTER(3, OnEnterBtnPML87)
	ON_HMIBTN_ENTER(4, OnEnterBtnPML50)
	ON_HMIBTN_ENTER(5, OnEnterBtnUIAngle)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndReport::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnActionReport.SetPosition(23,28,218,53,0);
	...
	m_BtnAlarmReport.SetPosition(23,61,218,86,0);
	...
	m_BtnStartReport.SetPosition(23,94,218,119,0);
	...
	m_BtnSoe.SetPosition(23,127,218,152,0);
	...
	m_BtnOperation.SetPosition(23,29,218,54,1);
...
BOOL CLcdWndSettingQueryAreaNumInput::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditAreaNum.SetPosition(176,81,206,101,0);
	...
	m_Static4883.SetPosition(14,81,159,101,0);
	...
	m_Static4915.SetPosition(14,44,159,64,0);
	...
	m_StaticNowAreaNum.SetPosition(176,44,206,59,0);
...
BOOL CLcdWndSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSettingQuery.SetPosition(21,28,211,53,0);
	...
	m_BtnsettingModify.SetPosition(21,61,211,86,0);
	...
	m_BtnSettingCopy.SetPosition(21,94,211,119,0);
	...
	m_BtnsettingExChg.SetPosition(21,127,211,152,0);
	...
	m_BtnASQuery.SetPosition(22,33,212,58,1);
	...
	m_BtnASModify.SetPosition(22,66,212,91,1);
...
BOOL CLcdWndSettingSave::Init()
{
	...
	m_Static4697.SetPosition(32,37,197,57,0);
	...
	m_Static4698.SetPosition(32,61,197,81,0);
...
BOOL CLcdWndSettingCopy::Init()
{
	...
	SetLRFun(1);
	SetLROffset(1);
	m_EditSoureAreaNum.SetPosition(160,43,210,63,0);
	...
	m_EditDstStartAreaNum.SetPosition(46,116,96,136,0);
	...
	m_EditDstEndAreaNum.SetPosition(138,116,188,136,0);
	...
	m_Static4710.SetPosition(14,44,139,64,0);
	...
	m_Static4886.SetPosition(102,116,132,131,0);
	...
	m_Static5350.SetPosition(193,116,218,136,0);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnAdress.SetPosition(21,28,221,53,0);
	...
	m_BtnInputSetting.SetPosition(21,61,221,86,0);
	...
	m_BtnBOTime.SetPosition(21,94,221,119,0);
	...
	m_BtnDeviceTime.SetPosition(21,127,221,152,0);
	...
	m_BtnLanguage.SetPosition(21,30,221,55,1);
	...
	m_BtnPassSetting.SetPosition(21,63,221,88,1);
	...
	m_BtnSysParam.SetPosition(21,96,221,121,1);
...
BOOL CLcdWndtime::Init()
{
	...
	m_EditHour.SetPosition(26,112,66,132,0);
	...
	m_EditMinute.SetPosition(93,112,133,132,0);
	...
	m_EditSecond.SetPosition(161,112,201,132,0);
	...
	m_Static4739.SetPosition(26,88,71,108,0);
	...
	m_Static4740.SetPosition(93,88,138,108,0);
	...
	m_Static4741.SetPosition(161,88,206,108,0);
...
BOOL CLcdWndInputSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSoeProperty.SetPosition(20,30,215,55,0);
	...
	m_BtnBIFilter.SetPosition(20,63,215,88,0);
	...
	m_BtnBiNo.SetPosition(20,97,215,122,0);
...
BOOL CLcdWndTest::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnOutputTest.SetPosition(18,28,223,53,0);
	...
	m_BtnLenTest.SetPosition(18,61,223,86,0);
	...
	m_BtnReportTest.SetPosition(18,94,223,119,0);
	...
	m_BtnManualREC.SetPosition(18,127,223,152,0);
	...
	m_BtnfactorySet.SetPosition(18,34,223,59,1);
...
BOOL CLcdWndfactorySet::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnManualCoef.SetPosition(26,29,221,54,0);
	...
	m_BtnAutoCoef.SetPosition(26,62,221,87,0);
...
BOOL CLcdWndManualREC::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Staticstatic1.SetPosition(8,43,233,63,0);
	...
	m_Staticstatic2.SetPosition(8,73,233,93,0);
	...
	m_Staticstatic3.SetPosition(8,95,233,115,0);
...
BOOL CLcdWndOutputTest::Init()
{
	...
	m_EditOutputNum.SetValueRange(19,1);
	...
	m_Static4776.SetPosition(16,123,181,143,0);
...
BOOL CLcdWndAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnCAN.SetPosition(20,32,215,57,0);
	...
	m_BtnETH.SetPosition(20,62,215,87,0);
	...
	m_BtnPortPara.SetPosition(20,92,215,117,0);
	...
	m_BtnSerialSet.SetPosition(20,122,215,147,0);
...
BOOL CLcdWndEthadd::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnetha.SetPosition(21,32,216,57,0);
	...
	m_Btnethb.SetPosition(21,62,216,87,0);
...
BOOL CLcdWndCANAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnenter.SetPosition(42,111,102,136,0);
	...
	m_EditCANA.SetPosition(103,52,153,77,0);
	...
	m_Static5439.SetPosition(20,52,95,77,0);
	m_Static5439.SetTabOrder(-4);
	m_pObjList[4] = &m_Static5439;
	m_Static5439.SetFont(16);
	m_Static5439.SetOwner(this);
	m_Static5439.SetCaption(tr("设备地址:"));
	m_Static5439.SetDataSource(-1,0);
	m_Static5439.SetTimer(0);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(4);
...
BOOL CLcdWndPassChange::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnChgCommonPass.SetPosition(25,38,220,63,0);
	...
	m_BtnChgSettingPass.SetPosition(25,71,220,96,0);
...
BOOL CLcdWndsyspara::Init()
{
	...
	m_BtnIRGBType.SetPosition(18,93,223,118,0);
...
BOOL CLcdWndWStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDevStatus.SetPosition(22,31,217,56,0);
...
void CLcdApp::Init()
{
	...
	m_pWndList[40] = &m_WndPortStatus;
	m_pWndList[41] = &m_WndSettingSwitchConfirm;
