...
public:
	...
	void OnEnterBtnPML87();
	void OnEnterBtnPML50();
	void OnEnterBtnUIAngle();
	CHmiButton m_BtnHMeasure;
	CHmiButton m_BtnLMeasure;
	CHmiButton m_BtnPML87;
	CHmiButton m_BtnPML50;
	CHmiButton m_BtnUIAngle;
