...
BOOL CLcdWndMeasure::Init()
{
	...
	m_Btnsyc.SetPosition(21,28,216,53,1);
	m_Btnsyc.SetTabOrder(5);
	m_pObjList[5] = &m_Btnsyc;
	m_Btnsyc.SetFont(16);
	m_Btnsyc.SetOwner(this);
	m_Btnsyc.SetCaption(tr("检同期"));
	m_Btnsyc.SetHaveEnterFun(TRUE);
	m_Btnsyc.SetEnterWnd(NULL);
	m_BtnKilowatt.SetPosition(21,61,216,86,1);
	m_BtnKilowatt.SetTabOrder(6);
	m_pObjList[6] = &m_BtnKilowatt;
	...
	m_BtnJDXX.SetPosition(21,94,216,119,1);
	m_BtnJDXX.SetTabOrder(7);
	m_pObjList[7] = &m_BtnJDXX;
	m_BtnJDXX.SetFont(16);
	m_BtnJDXX.SetOwner(this);
	m_BtnJDXX.SetCaption(tr("接地选线"));
	m_BtnJDXX.SetHaveEnterFun(TRUE);
	m_BtnJDXX.SetEnterWnd(NULL);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(2);
	SetObjNum(7);
...
//{{HMI_MSG_MAP(CLcdWndMeasure)
	...
	ON_HMIBTN_ENTER(5, OnEnterBtnsyc)
	ON_HMIBTN_ENTER(6, OnEnterBtnKilowatt)
	ON_HMIBTN_ENTER(7, OnEnterBtnJDXX)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndReport::Init()
{
	...
	m_BtnOperation.SetPosition(25,33,215,58,1);
...
BOOL CLcdWndSetting::Init()
{
	...
	m_BtnASQuery.SetPosition(26,33,211,58,1);
	...
	m_BtnASModify.SetPosition(26,66,211,91,1);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	m_BtnBOTime.SetPosition(17,94,217,119,0);
	...
	m_BtnCIPara.SetPosition(17,127,217,152,0);
	m_BtnCIPara.SetTabOrder(4);
	m_pObjList[4] = &m_BtnCIPara;
	m_BtnCIPara.SetFont(16);
	m_BtnCIPara.SetOwner(this);
	m_BtnCIPara.SetCaption(tr("电度参数"));
	m_BtnCIPara.SetHaveEnterFun(FALSE);
	m_BtnCIPara.SetEnterWnd((CHmiWnd*)&(CLcdApp::m_WndCIPara));
...
BOOL CLcdWndCIPara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDIProperty.SetPosition(26,28,211,53,0);
	...
	m_BtnIntegralKW.SetPosition(26,59,211,84,0);
	...
	m_BtnCIbase.SetPosition(26,90,211,115,0);
	...
	m_BtnPulseConst.SetPosition(26,121,211,146,0);
...
BOOL CLcdWndTest::Init()
{
	...
	m_BtnFactoryData.SetPosition(17,33,217,58,1);
	m_BtnFactoryData.SetTabOrder(5);
	m_pObjList[5] = &m_BtnFactoryData;
	m_BtnFactoryData.SetFont(16);
	m_BtnFactoryData.SetOwner(this);
	m_BtnFactoryData.SetCaption(tr("出厂设置"));
	m_BtnFactoryData.SetHaveEnterFun(TRUE);
	m_BtnFactoryData.SetEnterWnd((CHmiWnd*)&(CLcdApp::m_WndfactorySet));
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(2);
	SetObjNum(5);
...
//{{HMI_MSG_MAP(CLcdWndTest)
	ON_HMIBTN_ENTER(5, OnEnterBtnFactoryData)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndfactorySet::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnManualCoef.SetPosition(19,31,214,56,0);
	...
	m_BtnAutoCoef.SetPosition(19,63,214,88,0);
...
BOOL CLcdWndOutputTest::Init()
{
	...
	m_EditOutputTime.SetPosition(154,60,189,80,0);
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(28,28,213,53,0);
	...
	m_BtnProtocol.SetPosition(28,61,213,86,0);
...
void CLcdApp::Init()
{
	...
	m_pWndList[21] = &m_WndCIPara;
	m_pWndList[22] = &m_WndBOTime;
