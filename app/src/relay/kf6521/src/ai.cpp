...
{		
	...
	m_AIDataMask = ( (0x01<<CHANNEL_6521_UA)|(0x01<<CHANNEL_6521_UB)|(0x01<<CHANNEL_6521_UC)|\
						(0x01<<CHANNEL_6521_U0)|(0x01<<CHANNEL_6521_U1)|(0x01<<CHANNEL_6521_U2)|\
						(0x01<<CHANNEL_6521_U3)|(0x01<<CHANNEL_6521_IAM)|(0x01<<CHANNEL_6521_IBM)|\
						(0x01<<CHANNEL_6521_ICM)|(0x01<<CHANNEL_6521_I0)|(0x01<<CHANNEL_6521_I1)|\
						(0x01<<CHANNEL_6521_IA)|(0x01<<CHANNEL_6521_IB)|(0x01<<CHANNEL_6521_IC));		//yanxs  2013-03-22 CT断线检查增加保护电流

	m_CoefAdjustMask = ( (0x01<<CHANNEL_6521_UA)|(0x01<<CHANNEL_6521_UB)|(0x01<<CHANNEL_6521_UC)|\
						(0x01<<CHANNEL_6521_U0)|(0x01<<CHANNEL_6521_U1)|(0x01<<CHANNEL_6521_U2)|\
						(0x01<<CHANNEL_6521_U3)|(0x01<<CHANNEL_6521_IAM)|(0x01<<CHANNEL_6521_IBM)|\
						(0x01<<CHANNEL_6521_ICM)|(0x01<<CHANNEL_6521_I0)|(0x01<<CHANNEL_6521_I1)| \
...
/*	static WORD freqcounter =0;
	...
	{
		BOOL rc;
		rc = TestFrequence(m_dwPreFreq,M_U,m_dwFreqMask,m_wFreqBuf,m_FreqCaluBuf,m_dwFreq);
		if(rc)
		{
