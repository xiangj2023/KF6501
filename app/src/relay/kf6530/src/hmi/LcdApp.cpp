...
BOOL CLcdWndMainMenu::Init()
{
	...
	SetCaption(tr("KF6530电铁变压器差动保护装置"));
	SetEscWnd(NULL);
	SetEnterWnd(NULL);
	SetUDFun(0);
	SetUDOffset(2);
...
BOOL CLcdWndReport::Init()
{
	...
	m_BtnOperation.SetPosition(18,34,208,59,1);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	m_BtnDeviceTime.SetPosition(16,127,216,152,0);
	...
	m_BtnLanguage.SetPosition(17,34,217,59,1);
	...
	m_BtnPassSetting.SetPosition(17,67,217,92,1);
	...
	m_BtnSysParam.SetPosition(17,100,217,125,1);
...
BOOL CLcdWndsyspara::Init()
{
	...
	m_BtnDefaultPara.SetPosition(17,128,222,153,0);
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(40,28,200,53,0);
	...
	m_BtnProtocol.SetPosition(40,60,200,85,0);
