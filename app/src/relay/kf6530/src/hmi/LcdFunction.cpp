...
{		
	...
	WORD whAIIndex[] = {RM_UA,RM_UB,RM_UC,RM_IHA,RM_IHB,RM_IHC,RM_IL1,RM_IL2,RM_IL3,RM_IL4};	
	g_AIDlg.DoModal(this, this, phAI,10,whAIIndex,DlgCaption);
}
...
void CLcdWndMeasure::OnEnterBtnPML()
{
	...
	WORD whAIIndex[] = {RM_UA,RM_UB,RM_UC,RM_IHA,RM_IHB,RM_IHC,RM_IL1,RM_IL2,RM_IL3,RM_IL4,RM_IDA,RM_IDB,\
		RM_IDC,RM_IRA,RM_IRB,RM_IRC,RM_IDA2,RM_IDA3,RM_IDA5,RM_IDB2,RM_IDB3,RM_IDB5,RM_IDC2,RM_IDC3,RM_IDC5,\
		RM_IRA2,RM_IRB2,RM_IRC2,RM_AIHA,RM_AIHB,RM_AIHC,RM_AIL1,RM_AIL2,RM_AIL3,RM_AIL4};	
	g_AIDlg.DoModal(this, this, plAI,35,whAIIndex,DlgCaption);
}
void CLcdWndMeasure::OnEnterBtnHMe()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("一次侧测量值\n"));
	WORD whAIIndex[] = {M_UA,M_UB,M_UC,M_IHAM,M_IHBM,M_IHCM,M_IL1M,M_IL2M,M_IL3M,M_IL4M};	
	g_AIDlg.DoModal(this, this, hAI,10,whAIIndex,DlgCaption);
}
...
void CLcdWndMeasure::OnEnterBtnLMe()
{
	...
	WORD whAIIndex[] = {M_UA,M_UB,M_UC,M_IHAM,M_IHBM,M_IHCM,M_IL1M,M_IL2M,M_IL3M,M_IL4M};	
	g_AIDlg.DoModal(this, this, lAI,10,whAIIndex,DlgCaption);
}
