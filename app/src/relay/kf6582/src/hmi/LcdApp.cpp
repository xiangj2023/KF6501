...
BOOL CLcdWndMeasure::Init()
{
	...
	m_BtnLMeasure.SetPosition(21,63,216,88,0);
...
BOOL CLcdWndReport::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnActionReport.SetPosition(19,28,214,53,0);
	...
	m_BtnAlarmReport.SetPosition(19,61,214,86,0);
	...
	m_BtnStartReport.SetPosition(19,96,214,121,0);
	...
	m_BtnSoe.SetPosition(19,130,214,155,0);
	...
	m_BtnOperation.SetPosition(19,28,214,53,1);
...
BOOL CLcdWndSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSettingQuery.SetPosition(17,31,222,56,0);
	...
	m_BtnsettingModify.SetPosition(17,62,222,87,0);
	...
	m_BtnSettingCopy.SetPosition(17,93,222,118,0);
	...
	m_BtnsettingExChg.SetPosition(17,126,222,151,0);
	...
	m_BtnASQuery.SetPosition(17,27,222,52,1);
	...
	m_BtnASModify.SetPosition(17,57,222,82,1);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnAdress.SetPosition(17,31,222,56,0);
	...
	m_BtnInputSetting.SetPosition(17,64,222,89,0);
	...
	m_BtnBOTime.SetPosition(17,97,222,122,0);
	...
	m_BtnDeviceTime.SetPosition(17,130,222,155,0);
	...
	m_BtnLanguage.SetPosition(17,27,222,52,1);
	...
	m_BtnPassSetting.SetPosition(17,60,222,85,1);
	...
	m_BtnSysParam.SetPosition(17,94,222,119,1);
...
BOOL CLcdWndtime::Init()
{
	...
	m_EditHour.SetPosition(26,113,66,133,0);
	...
	m_EditMinute.SetPosition(93,113,133,133,0);
	...
	m_EditSecond.SetPosition(161,113,201,133,0);
	...
	m_Static4739.SetPosition(26,86,66,106,0);
	...
	m_Static4740.SetPosition(93,86,133,106,0);
	...
	m_Static4741.SetPosition(161,86,201,106,0);
...
BOOL CLcdWndInputSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSoeProperty.SetPosition(22,36,217,61,0);
	...
	m_BtnBIFilter.SetPosition(22,68,217,93,0);
	...
	m_BtnBiNo.SetPosition(22,101,217,126,0);
...
BOOL CLcdWndTest::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnOutputTest.SetPosition(17,31,217,56,0);
	...
	m_BtnLenTest.SetPosition(17,61,217,86,0);
	...
	m_BtnManualREC.SetPosition(17,123,217,148,0);
	...
	m_BtnfactorySet.SetPosition(17,29,217,54,1);
...
BOOL CLcdWndOutputTest::Init()
{
	...
	m_StaticOutputName.SetPosition(18,97,183,112,0);
	...
	m_Static4776.SetPosition(13,123,178,143,0);
...
BOOL CLcdWndAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnCAN.SetPosition(15,29,220,54,0);
	...
	m_BtnETH.SetPosition(15,60,220,85,0);
	...
	m_BtnPortpara.SetPosition(15,91,220,116,0);
	...
	m_BtnSerialset.SetPosition(15,122,220,147,0);
...
BOOL CLcdWndEthadd::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnetha.SetPosition(20,34,220,59,0);
	...
	m_Btnethb.SetPosition(20,69,220,94,0);
...
BOOL CLcdWndCANA::Init()
{
	...
	m_EditCANA.SetPosition(111,44,156,69,0);
	...
	m_Static5464.SetPosition(25,49,100,74,0);
...
BOOL CLcdWndPassChange::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnChgCommonPass.SetPosition(20,43,215,68,0);
	...
	m_BtnChgSettingPass.SetPosition(20,74,215,99,0);
...
BOOL CLcdWndsyspara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnContrast.SetPosition(19,32,224,57,0);
	...
	m_BtnFVDH.SetPosition(19,65,224,90,0);
	...
	m_BtnIRGBType.SetPosition(19,99,224,124,0);
	...
	m_BtnDefaultPara.SetPosition(19,130,224,155,0);
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(35,30,205,55,0);
	...
	m_BtnProtocol.SetPosition(35,63,205,88,0);
...
BOOL CLcdWndWStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDevStatus.SetPosition(23,31,218,56,0);
	...
	m_BtnComStatus.SetPosition(23,62,218,87,0);
