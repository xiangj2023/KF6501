...
{		
	...
	WORD whAIIndex[] = {M_UM1,M_UM2,M_UM3,M_UM4,M_UM5,M_UM6,M_UM7,M_UM8,M_IM1,M_IM2,M_IM3,M_IM4,M_IM5,M_IM6,M_IM7,M_IM8};	
...
void CLcdWndMeasure::OnEnterBtnPML()
{
	...
	WORD whAIIndex[] = {RM_UP1,RM_UP2,RM_UP3,RM_UP4,RM_UP5,RM_UP6,RM_UP7,RM_UP8,RM_IP1,RM_IP2,RM_IP3,RM_IP4,RM_IP5,RM_IP6,RM_IP7,RM_IP8}; 
	g_AIDlg.DoModal(this, this, plAI,16,whAIIndex,DlgCaption);
}
...
void CLcdWndCANA::OnEnterBtnenter()
{
	BYTE DevID;
	STATUS rc;
...
void CLcdWndManualREC::OnWndEnter()
{
	TAbsTime abstime;
	ReadAbsTime(&abstime);
	OS_PostMessage(g_hDbaseTaskID, SM_STARTDIST,*AS_pnRECD*16/10, dwRelayDataPtr,abstime.Lo,abstime.Hi);
	CHmiWnd::OnWndEnter();
