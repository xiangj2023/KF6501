...
{
	m_AIDataMask = ( (0x01<<CHANNEL_6582_U1)|(0x01<<CHANNEL_6582_U2)|(0x01<<CHANNEL_6582_U3)|(0x01<<CHANNEL_6582_U4) \
...
/*			
			...
			for(LONG i=0;i<6;i++)
			{
				m_dwPreFreq += m_dwFreq[i];
			}
			m_dwPreFreq = m_dwPreFreq/60;
...
void CAIProc::CoefAdjust(void)
{
	...
	if(m_dwAdjustCnt>99)
	{
		...
		{			
			...
			Value[16]	= m_pAdjustData[16]/m_dwSourceU;				//U1m
			Value[17]	= m_pAdjustData[17]/m_dwSourceU;				//U2m
			Value[18]	= m_pAdjustData[18]/m_dwSourceU;				//U3m
			Value[19]	= m_pAdjustData[19]/m_dwSourceU;				//U4m
			Value[20]	= m_pAdjustData[20]/m_dwSourceU;				//U5m
			Value[21]	= m_pAdjustData[21]/m_dwSourceU;				//U6m
			Value[22]	= m_pAdjustData[22]/m_dwSourceU;				//U7m
			Value[23]	= m_pAdjustData[23]/m_dwSourceU;				//U8m
			Value[24]	= m_pAdjustData[24]/(10*m_dwSourceI);			//I1m
			Value[25]	= m_pAdjustData[25]/(10*m_dwSourceI);			//I2m
			Value[26]	= m_pAdjustData[26]/(10*m_dwSourceI);			//I3m
			Value[27]	= m_pAdjustData[27]/(10*m_dwSourceI);			//I4m
			Value[28]	= m_pAdjustData[28]/(10*m_dwSourceI);			//I5m
			Value[29]	= m_pAdjustData[29]/(10*m_dwSourceI);			//I6m
			Value[30]	= m_pAdjustData[30]/(10*m_dwSourceI);			//I7m
			Value[31]	= m_pAdjustData[31]/(10*m_dwSourceI);			//I8m			
			Value[32]	= 1000;
			Value[33]	= 100;
			Value[34]	= 10;
			Value[35]	= 1;	
