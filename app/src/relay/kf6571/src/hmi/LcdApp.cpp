...
BOOL CLcdWndMeasure::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnsecondval.SetPosition(16,28,221,53,0);
	m_Btnsecondval.SetTabOrder(1);
	m_pObjList[1] = &m_Btnsecondval;
	m_Btnsecondval.SetFont(16);
	m_Btnsecondval.SetOwner(this);
	m_Btnsecondval.SetCaption(tr("本所二次值"));
	m_Btnsecondval.SetHaveEnterFun(TRUE);
	m_Btnsecondval.SetEnterWnd(NULL);
	m_BtnSubstation.SetPosition(16,60,221,85,0);
	m_BtnSubstation.SetTabOrder(2);
	m_pObjList[2] = &m_BtnSubstation;
	m_BtnSubstation.SetFont(0);
	m_BtnSubstation.SetOwner(this);
	m_BtnSubstation.SetCaption(tr("主所一次值"));
	m_BtnSubstation.SetHaveEnterFun(TRUE);
	m_BtnSubstation.SetEnterWnd(NULL);
	m_Btnsub1.SetPosition(16,92,221,117,0);
	m_Btnsub1.SetTabOrder(3);
	m_pObjList[3] = &m_Btnsub1;
	m_Btnsub1.SetFont(0);
	m_Btnsub1.SetOwner(this);
	m_Btnsub1.SetCaption(tr("子所1一次值"));
	m_Btnsub1.SetHaveEnterFun(TRUE);
	m_Btnsub1.SetEnterWnd(NULL);
	m_Btnsub2.SetPosition(16,124,221,149,0);
	m_Btnsub2.SetTabOrder(4);
	m_pObjList[4] = &m_Btnsub2;
	m_Btnsub2.SetFont(16);
	m_Btnsub2.SetOwner(this);
	m_Btnsub2.SetCaption(tr("子所2一次值"));
	m_Btnsub2.SetHaveEnterFun(TRUE);
	m_Btnsub2.SetEnterWnd(NULL);
	m_Btnsub3.SetPosition(16,27,221,52,1);
	m_Btnsub3.SetTabOrder(5);
	m_pObjList[5] = &m_Btnsub3;
	m_Btnsub3.SetFont(16);
	m_Btnsub3.SetOwner(this);
	m_Btnsub3.SetCaption(tr("子所3一次值"));
	m_Btnsub3.SetHaveEnterFun(TRUE);
	m_Btnsub3.SetEnterWnd(NULL);
	m_Btnsub4.SetPosition(16,59,221,84,1);
	m_Btnsub4.SetTabOrder(6);
	m_pObjList[6] = &m_Btnsub4;
	m_Btnsub4.SetFont(16);
	m_Btnsub4.SetOwner(this);
	m_Btnsub4.SetCaption(tr("子所4一次值"));
	m_Btnsub4.SetHaveEnterFun(TRUE);
	m_Btnsub4.SetEnterWnd(NULL);
	m_Btnsub5.SetPosition(16,92,221,117,1);
	m_Btnsub5.SetTabOrder(7);
	m_pObjList[7] = &m_Btnsub5;
	m_Btnsub5.SetFont(16);
	m_Btnsub5.SetOwner(this);
	m_Btnsub5.SetCaption(tr("子所5一次值"));
	m_Btnsub5.SetHaveEnterFun(TRUE);
	m_Btnsub5.SetEnterWnd(NULL);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(2);
	SetObjNum(7);
...
//{{HMI_MSG_MAP(CLcdWndMeasure)
	ON_HMIBTN_ENTER(1, OnEnterBtnsecondval)
	ON_HMIBTN_ENTER(2, OnEnterBtnSubstation)
	ON_HMIBTN_ENTER(3, OnEnterBtnsub1)
	ON_HMIBTN_ENTER(4, OnEnterBtnsub2)
	ON_HMIBTN_ENTER(5, OnEnterBtnsub3)
	ON_HMIBTN_ENTER(6, OnEnterBtnsub4)
	ON_HMIBTN_ENTER(7, OnEnterBtnsub5)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndReport::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnActionReport.SetPosition(18,28,208,53,0);
	...
	m_BtnAlarmReport.SetPosition(18,61,208,86,0);
	...
	m_BtnStartReport.SetPosition(18,94,208,119,0);
	...
	m_BtnSoe.SetPosition(18,127,208,152,0);
	...
	m_BtnOperation.SetPosition(18,31,208,56,1);
...
BOOL CLcdWndSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSettingQuery.SetPosition(17,28,227,53,0);
	...
	m_BtnsettingModify.SetPosition(17,61,227,86,0);
	...
	m_BtnSettingCopy.SetPosition(17,94,227,119,0);
	...
	m_BtnsettingExChg.SetPosition(17,127,227,152,0);
	...
	m_BtnASQuery.SetPosition(17,28,227,53,1);
	...
	m_BtnASModify.SetPosition(17,61,227,86,1);
...
BOOL CLcdWndSettingSwitch::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditAreaNum.SetPosition(132,118,182,138,0);
	m_EditAreaNum.SetTabOrder(1);
	m_pObjList[1] = &m_EditAreaNum;
	m_EditAreaNum.SetFont(16);
	m_EditAreaNum.SetOwner(this);
	...
	m_Static4706.SetPosition(16,90,226,110,0);
	...
	m_StaticNowAreaNum.SetPosition(132,57,162,77,0);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	m_BtnInputSetting.SetPosition(17,59,217,84,0);
	...
	m_BtnBOTime.SetPosition(17,92,217,117,0);
	...
	m_BtnDeviceTime.SetPosition(17,125,217,150,0);
	...
	m_BtnLanguage.SetPosition(17,31,217,56,1);
	...
	m_BtnPassSetting.SetPosition(17,63,217,88,1);
	...
	m_BtnSysParam.SetPosition(17,95,217,120,1);
...
BOOL CLcdWndInputSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSoeProperty.SetPosition(20,28,220,53,0);
	...
	m_BtnBIFilter.SetPosition(20,61,220,86,0);
	...
	m_BtnBiNo.SetPosition(20,94,220,119,0);
...
BOOL CLcdWndTest::Init()
{
	...
	m_BtnfactorySet.SetPosition(28,33,218,58,1);
...
BOOL CLcdWndfactorySet::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnManualCoef.SetPosition(21,29,221,54,0);
...
BOOL CLcdWndOutputTest::Init()
{
	...
	m_EditOutputNum.SetValueRange(14,1);
...
BOOL CLcdWndAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnCAN.SetPosition(14,28,224,53,0);
	...
	m_BtnETH.SetPosition(14,61,224,86,0);
	...
	m_BtnPortpara.SetPosition(14,94,224,119,0);
	...
	m_BtnSerialset.SetPosition(14,127,224,152,0);
...
BOOL CLcdWndEthadd::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnetha.SetPosition(26,33,211,58,0);
	...
	m_Btnethb.SetPosition(26,64,211,89,0);
...
BOOL CLcdWndPassChange::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnChgCommonPass.SetPosition(23,38,218,63,0);
	...
	m_BtnChgSettingPass.SetPosition(23,69,218,94,0);
...
BOOL CLcdWndsyspara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnContrast.SetPosition(18,37,213,62,0);
	...
	m_BtnIRGBType.SetPosition(18,70,213,95,0);
	m_BtnIRGBType.SetTabOrder(2);
	m_pObjList[2] = &m_BtnIRGBType;
	...
	m_BtnDefaultPara.SetPosition(18,103,213,128,0);
...
//{{HMI_MSG_MAP(CLcdWndsyspara)
	...
	ON_HMIBTN_ENTER(2, OnEnterBtnIRGBType)
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(38,30,203,55,0);
	...
	m_BtnProtocol.SetPosition(38,62,203,87,0);
...
BOOL CLcdWndWStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDevStatus.SetPosition(16,31,226,56,0);
	...
	m_BtnComStatus.SetPosition(16,61,226,86,0);
