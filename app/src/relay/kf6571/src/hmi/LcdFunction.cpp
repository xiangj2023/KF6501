...
extern subChannelCheck 		HeartbeatFLData[4];
extern subChannelCheck 		ManualFLData[4];
extern subChannelCheck 		RelayFLData[4];
extern subChannelCheck 		ForeFLData[4];
extern subChannelCheck 		LowValFLData[4];
//extern SubData FLTest;
...
BOOL CLcdWndMeasure::OnWndInit()
{
	if(*CFG_pbyISSS == CFG_STATUS_SET)
	{
		m_BtnSubstation.SetCaption(tr("主所一次值"));
		
//		if(*CFG_pbyAT_C_RATE == CFG_STATUS_CLR)
//		{
//			m_Btnsub1.SetVisible(FALSE);
//			m_Btnsub2.SetVisible(FALSE);
//			m_Btnsub3.SetVisible(FALSE);
//			m_Btnsub4.SetVisible(FALSE);	
//			m_Btnsub5.SetVisible(FALSE);
//		}
		if(*RS_pnN == 0)
		{
			m_Btnsub1.SetVisible(FALSE);
		...
		else if(*RS_pnN == 5)
		{
			...
			m_Btnsub3.SetVisible(TRUE);
			m_Btnsub4.SetVisible(TRUE);
			m_Btnsub5.SetVisible(TRUE);
		}
	}
	else
	{
		m_BtnSubstation.SetCaption(tr("本所一次值"));
		m_Btnsub1.SetVisible(FALSE);
		m_Btnsub2.SetVisible(FALSE);
		m_Btnsub3.SetVisible(FALSE);
		m_Btnsub4.SetVisible(FALSE);	
...
void CLcdWndMeasure::OnEnterBtnsecondval()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("本所二次值"));
	
	WORD wHarmIndex[] = {RM_U1,RM_U2,RM_U3,RM_U4,RM_UP,RM_I1,RM_IT1,RM_IF1,RM_I2,RM_IT2,RM_IF2,RM_I3,RM_IT3,RM_IF3,RM_IAT1,RM_IAT2,\
		RM_IP_H2,RM_IP_H3,RM_IP_H5,RM_R_T,RM_X_T,RM_R_F,RM_X_F,RM_R_TF,RM_X_TF,RM_U1A,RM_U2A,RM_IT1A,RM_IF1A,RM_IT2A,RM_IF2A,RM_IT3A,RM_IF3A};
	g_AIDlg.DoModal(this, this, plAI, 33, wHarmIndex,DlgCaption);
}

void CLcdWndMeasure::OnEnterBtnSubstation()
{
	char DlgCaption[64];
	if(*CFG_pbyISSS == CFG_STATUS_SET)
		sprintf(DlgCaption, tr("主所一次值"));
	else
		sprintf(DlgCaption, tr("本所一次值"));
	
	WORD wHarmIndex[] = {RM_U1,RM_U2,RM_U3,RM_U4,RM_UP,RM_I1,RM_IT1,RM_IF1,RM_I2,RM_IT2,RM_IF2,RM_I3,RM_IT3,RM_IF3,RM_IAT1,RM_IAT2,RM_U1A, RM_U2A, 
		RM_U3A,RM_U4A,RM_IT1A,RM_IF1A,RM_IT2A,RM_IF2A,RM_IT3A,RM_IF3A,RM_NS};
	g_AIDlg.DoModal(this, this, phAI, 27, wHarmIndex,DlgCaption);
}
void CLcdWndMeasure::OnEnterBtnsub1()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("子所1一次值"));
	
	WORD wHarmIndex[] = {RM_SUB1_U1,RM_SUB1_U2,RM_SUB1_U3,RM_SUB1_U4,RM_SUB1_IT1,RM_SUB1_IF1,RM_SUB1_IT2,RM_SUB1_IF2,RM_SUB1_IT3,
		RM_SUB1_IF3,RM_SUB1_IAT1,RM_SUB1_IAT2,RM_SUB1_AIT1,RM_SUB1_AIF1,RM_SUB1_AIT2,RM_SUB1_AIF2,RM_SUB1_AIT3,RM_SUB1_AIF3,
		RM_SUB1_YEAR,RM_SUB1_MONTH,RM_SUB1_DAY,RM_SUB1_HOUR,RM_SUB1_MINUTE,RM_SUB1_NS,RM_SUB1_STATUS};
	g_AIDlg.DoModal(this, this, phAI, 25, wHarmIndex,DlgCaption);
}


void CLcdWndMeasure::OnEnterBtnsub2()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("子所2一次值"));
	
	WORD wHarmIndex[] = {RM_SUB2_U1,RM_SUB2_U2,RM_SUB2_U3,RM_SUB2_U4,RM_SUB2_IT1,RM_SUB2_IF1,RM_SUB2_IT2,RM_SUB2_IF2,RM_SUB2_IT3,
		RM_SUB2_IF3,RM_SUB2_IAT1,RM_SUB2_IAT2,RM_SUB2_AIT1,RM_SUB2_AIF1,RM_SUB2_AIT2,RM_SUB2_AIF2,RM_SUB2_AIT3,RM_SUB2_AIF3,
		RM_SUB2_YEAR,RM_SUB2_MONTH,RM_SUB2_DAY,RM_SUB2_HOUR,RM_SUB2_MINUTE,RM_SUB2_NS,RM_SUB2_STATUS};
	g_AIDlg.DoModal(this, this, phAI, 25, wHarmIndex,DlgCaption);

}

void CLcdWndMeasure::OnEnterBtnsub3()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("子所3一次值"));
	
	WORD wHarmIndex[] = {RM_SUB3_U1,RM_SUB3_U2,RM_SUB3_U3,RM_SUB3_U4,RM_SUB3_IT1,RM_SUB3_IF1,RM_SUB3_IT2,RM_SUB3_IF2,RM_SUB3_IT3,
		RM_SUB3_IF3,RM_SUB3_IAT1,RM_SUB3_IAT2,RM_SUB3_AIT1,RM_SUB3_AIF1,RM_SUB3_AIT2,RM_SUB3_AIF2,RM_SUB3_AIT3,RM_SUB3_AIF3,
		RM_SUB3_YEAR,RM_SUB3_MONTH,RM_SUB3_DAY,RM_SUB3_HOUR,RM_SUB3_MINUTE,RM_SUB3_NS,RM_SUB3_STATUS};
	g_AIDlg.DoModal(this, this, phAI, 25, wHarmIndex,DlgCaption);
}

void CLcdWndMeasure::OnEnterBtnsub4()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("子所4一次值"));
	
	WORD wHarmIndex[] = {RM_SUB4_U1,RM_SUB4_U2,RM_SUB4_U3,RM_SUB4_U4,RM_SUB4_IT1,RM_SUB4_IF1,RM_SUB4_IT2,RM_SUB4_IF2,RM_SUB4_IT3,
		RM_SUB4_IF3,RM_SUB4_IAT1,RM_SUB4_IAT2,RM_SUB4_AIT1,RM_SUB4_AIF1,RM_SUB4_AIT2,RM_SUB4_AIF2,RM_SUB4_AIT3,RM_SUB4_AIF3,
		RM_SUB4_YEAR,RM_SUB4_MONTH,RM_SUB4_DAY,RM_SUB4_HOUR,RM_SUB4_MINUTE,RM_SUB4_NS,RM_SUB4_STATUS};
	g_AIDlg.DoModal(this, this, phAI, 25, wHarmIndex,DlgCaption);

}
void CLcdWndMeasure::OnEnterBtnsub5()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("子所5一次值"));
	
	WORD wHarmIndex[] = {RM_SUB5_U1,RM_SUB5_U2,RM_SUB5_U3,RM_SUB5_U4,RM_SUB5_IT1,RM_SUB5_IF1,RM_SUB5_IT2,RM_SUB5_IF2,RM_SUB5_IT3,
		RM_SUB5_IF3,RM_SUB5_IAT1,RM_SUB5_IAT2,RM_SUB5_AIT1,RM_SUB5_AIF1,RM_SUB5_AIT2,RM_SUB5_AIF2,RM_SUB5_AIT3,RM_SUB5_AIF3,
		RM_SUB5_YEAR,RM_SUB5_MONTH,RM_SUB5_DAY,RM_SUB5_HOUR,RM_SUB5_MINUTE,RM_SUB5_NS,RM_SUB5_STATUS};
	g_AIDlg.DoModal(this, this, phAI, 25, wHarmIndex,DlgCaption);
...
void CLcdWndSetting::OnEnterBtnASModify()
{
	...
	if(DB_ERR_OK != rc)
	{
		HMIMsgBox(tr("定值"),tr("读辅助公用失败!"), this,this);
	}
	else
	{
		//密码窗口
...
/*
void CLcdWndSysStatus::OnTimer(LONG TimerID)
{
	OnWndInit();
	OnPaint();
	UpdateWindow();
...
/*
BOOL CLcdWndSysStatus::OnWndInit()
{
	char format[16];
	char str[32];	
	DWORD word1,word2,word3;
	sprintf(format, "%s%df", "%03.", 1);	
	sprintf(str,format,(float)SysTemperatur/10);
	sprintf(str,"%s %s",str,"℃");
