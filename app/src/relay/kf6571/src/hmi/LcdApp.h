...
public:
	...
	void OnEnterBtnsecondval();
	void OnEnterBtnSubstation();
	void OnEnterBtnsub1();
	void OnEnterBtnsub2();
	void OnEnterBtnsub3();
	void OnEnterBtnsub4();
	void OnEnterBtnsub5();
	CHmiButton m_Btnsecondval;
	CHmiButton m_BtnSubstation;
	CHmiButton m_Btnsub1;
	CHmiButton m_Btnsub2;
	CHmiButton m_Btnsub3;
	CHmiButton m_Btnsub4;
	CHmiButton m_Btnsub5;
