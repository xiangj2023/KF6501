...
#define	             RW_RCE1  656	//RCE1-遥控执行继电器1
#define	             RW_RCE2  657	//RCE2-遥控执行继电器2
#define	             RW_RCE3  658	//RCE3-遥控执行继电器3
#define	             RW_RCE4  659	//RCE4-遥控执行继电器4
#define	             RW_RCE5  660	//RCE5-遥控执行继电器5
#define	             RW_RCE6  661	//RCE6-遥控执行继电器6
#define	             RW_RCE7  662	//RCE7-遥控执行继电器7
#define	             RW_RCE8  663	//RCE8-遥控执行继电器8
#define	             RW_RCE9  664	//RCE9-遥控执行继电器9
#define	            RW_RCE10  665	//RCE10-遥控执行继电器10
#define	            RW_RCE11  666	//RCE11-遥控执行继电器11
#define	            RW_RCE12  667	//RCE12-遥控执行继电器12
#define	            RW_RCE13  668	//RCE13-遥控执行继电器13
#define	            RW_RCE14  669	//RCE14-遥控执行继电器14
#define	            RW_RCE15  670	//RCE15-遥控执行继电器15
#define	            RW_RCE16  671	//RCE16-遥控执行继电器16
#define	            RW_RCE17  672	//RCE17-遥控执行继电器17
#define	            RW_RCE18  673	//RCE18-遥控执行继电器18
#define	            RW_RCE19  674	//RCE19-遥控执行继电器19
#define	            RW_RCE20  675	//RCE20-遥控执行继电器20
#define	            RW_RCE21  676	//RCE21-遥控执行继电器21
#define	            RW_RCE22  677	//RCE22-遥控执行继电器22
#define	            RW_RCE23  678	//RCE23-遥控执行继电器23
#define	            RW_RCE24  679	//RCE24-遥控执行继电器24
#define	            RW_RCE25  680	//RCE25-遥控执行继电器25
#define	            RW_RCE26  681	//RCE26-遥控执行继电器26
#define	            RW_RCE27  682	//RCE27-遥控执行继电器27
#define	            RW_RCE28  683	//RCE28-遥控执行继电器28
#define	            RW_RCE29  684	//RCE29-遥控执行继电器29
#define	            RW_RCE30  685	//RCE30-遥控执行继电器30
#define	            RW_RCE31  686	//RCE31-遥控执行继电器31
#define	            RW_RCE32  687	//RCE32-遥控执行继电器32
#define	            RW_RCE33  688	//RCE33-遥控执行继电器33
#define	            RW_RCE34  689	//RCE34-遥控执行继电器34
#define	            RW_RCE35  690	//RCE35-遥控执行继电器35
#define	            RW_RCE36  691	//RCE36-遥控执行继电器36
#define	            RW_RCE37  692	//RCE37-遥控执行继电器37
#define	            RW_RCE38  693	//RCE38-遥控执行继电器38
#define	            RW_RCE39  694	//RCE39-遥控执行继电器39
#define	            RW_RCE40  695	//RCE40-遥控执行继电器40
#define	            RW_RCE41  696	//RCE41-遥控执行继电器41
#define	            RW_RCE42  697	//RCE42-遥控执行继电器42
#define	            RW_RCE43  698	//RCE43-遥控执行继电器43
#define	            RW_RCE44  699	//RCE44-遥控执行继电器44
#define	            RW_RCE45  700	//RCE45-遥控执行继电器45
#define	            RW_RCE46  701	//RCE46-遥控执行继电器46
#define	            RW_RCE47  702	//RCE47-遥控执行继电器47
#define	            RW_RCE48  703	//RCE48-遥控执行继电器48
#define	             RW_RCV1  704	//RCV1-遥控反校继电器1
#define	             RW_RCV2  705	//RCV2-遥控反校继电器2
#define	             RW_RCV3  706	//RCV3-遥控反校继电器3
#define	             RW_RCV4  707	//RCV4-遥控反校继电器4
#define	             RW_RCV5  708	//RCV5-遥控反校继电器5
#define	             RW_RCV6  709	//RCV6-遥控反校继电器6
#define	             RW_RCV7  710	//RCV7-遥控反校继电器7
#define	             RW_RCV8  711	//RCV8-遥控反校继电器8
#define	             RW_RCV9  712	//RCV9-遥控反校继电器9
#define	            RW_RCV10  713	//RCV10-遥控反校继电器10
#define	            RW_RCV11  714	//RCV11-遥控反校继电器11
#define	            RW_RCV12  715	//RCV12-遥控反校继电器12
#define	            RW_RCV13  716	//RCV13-遥控反校继电器13
#define	            RW_RCV14  717	//RCV14-遥控反校继电器14
#define	            RW_RCV15  718	//RCV15-遥控反校继电器15
#define	            RW_RCV16  719	//RCV16-遥控反校继电器16
#define	            RW_RCV17  720	//RCV17-遥控反校继电器17
#define	            RW_RCV18  721	//RCV18-遥控反校继电器18
#define	            RW_RCV19  722	//RCV19-遥控反校继电器19
#define	            RW_RCV20  723	//RCV20-遥控反校继电器20
#define	            RW_RCV21  724	//RCV21-遥控反校继电器21
#define	            RW_RCV22  725	//RCV22-遥控反校继电器22
#define	            RW_RCV23  726	//RCV23-遥控反校继电器23
#define	            RW_RCV24  727	//RCV24-遥控反校继电器24
#define	            RW_RCV25  728	//RCV25-遥控反校继电器25
#define	            RW_RCV26  729	//RCV26-遥控反校继电器26
#define	            RW_RCV27  730	//RCV27-遥控反校继电器27
#define	            RW_RCV28  731	//RCV28-遥控反校继电器28
#define	            RW_RCV29  732	//RCV29-遥控反校继电器29
#define	            RW_RCV30  733	//RCV30-遥控反校继电器30
#define	            RW_RCV31  734	//RCV31-遥控反校继电器31
#define	            RW_RCV32  735	//RCV32-遥控反校继电器32
#define	            RW_RCV33  736	//RCV33-遥控反校继电器33
#define	            RW_RCV34  737	//RCV34-遥控反校继电器34
#define	            RW_RCV35  738	//RCV35-遥控反校继电器35
#define	            RW_RCV36  739	//RCV36-遥控反校继电器36
#define	            RW_RCV37  740	//RCV37-遥控反校继电器37
#define	            RW_RCV38  741	//RCV38-遥控反校继电器38
#define	            RW_RCV39  742	//RCV39-遥控反校继电器39
#define	            RW_RCV40  743	//RCV40-遥控反校继电器40
#define	            RW_RCV41  744	//RCV41-遥控反校继电器41
#define	            RW_RCV42  745	//RCV42-遥控反校继电器42
#define	            RW_RCV43  746	//RCV43-遥控反校继电器43
#define	            RW_RCV44  747	//RCV44-遥控反校继电器44
#define	            RW_RCV45  748	//RCV45-遥控反校继电器45
#define	            RW_RCV46  749	//RCV46-遥控反校继电器46
#define	            RW_RCV47  750	//RCV47-遥控反校继电器47
#define	            RW_RCV48  751	//RCV48-遥控反校继电器48
#define	              RW_GE1  752	//GE1-大于等于继电器1
#define	              RW_GE2  753	//GE2-大于等于继电器2
#define	              RW_GE3  754	//GE3-大于等于继电器3
#define	              RW_GE4  755	//GE4-大于等于继电器4
#define	              RW_GE5  756	//GE5-大于等于继电器5
#define	              RW_GE6  757	//GE6-大于等于继电器6
#define	              RW_GE7  758	//GE7-大于等于继电器7
#define	              RW_GE8  759	//GE8-大于等于继电器8
#define	              RW_CT1  760	//CT1-常数时间继电器1
#define	              RW_CT2  761	//CT2-常数时间继电器2
#define	              RW_CT3  762	//CT3-常数时间继电器3
#define	              RW_CT4  763	//CT4-常数时间继电器4
#define	              RW_CT5  764	//CT5-常数时间继电器5
#define	              RW_CT6  765	//CT6-常数时间继电器6
#define	              RW_CT7  766	//CT7-常数时间继电器7
#define	              RW_CT8  767	//CT8-常数时间继电器8
#define	              RW_TX1  768	//TX1-发送链接继电器字1
#define	              RW_TX2  769	//TX2-发送链接继电器字2
#define	              RW_TX3  770	//TX3-发送链接继电器字3
#define	              RW_TX4  771	//TX4-发送链接继电器字4
#define	              RW_TX5  772	//TX5-发送链接继电器字5
#define	              RW_TX6  773	//TX6-发送链接继电器字6
#define	              RW_TX7  774	//TX7-发送链接继电器字7
#define	              RW_TX8  775	//TX8-发送链接继电器字7
#define	              RW_TX9  776	//TX9-发送链接继电器字9
#define	             RW_TX10  777	//TX10-发送链接继电器字10
#define	             RW_TX11  778	//TX11-发送链接继电器字11
#define	             RW_TX12  779	//TX12-发送链接继电器字12
#define	             RW_TX13  780	//TX13-发送链接继电器字13
#define	             RW_TX14  781	//TX14-发送链接继电器字14
#define	             RW_TX15  782	//TX15-发送链接继电器字15
#define	             RW_TX16  783	//TX16-发送链接继电器字16
#define	              RW_RX1  784	//RX1-接收链接继电器字1
#define	              RW_RX2  785	//RX2-接收链接继电器字2
#define	              RW_RX3  786	//RX3-接收链接继电器字3
#define	              RW_RX4  787	//RX4-接收链接继电器字4
#define	              RW_RX5  788	//RX5-接收链接继电器字5
#define	              RW_RX6  789	//RX6-接收链接继电器字6
#define	              RW_RX7  790	//RX7-接收链接继电器字7
#define	              RW_RX8  791	//RX8-接收链接继电器字8
#define	              RW_RX9  792	//RX9-接收链接继电器字9
#define	             RW_RX10  793	//RX10-接收链接继电器字10
#define	             RW_RX11  794	//RX11-接收链接继电器字11
#define	             RW_RX12  795	//RX12-接收链接继电器字12
#define	             RW_RX13  796	//RX13-接收链接继电器字13
#define	             RW_RX14  797	//RX14-接收链接继电器字14
#define	             RW_RX15  798	//RX15-接收链接继电器字15
#define	             RW_RX16  799	//RX16-接收链接继电器字16
#define	             RW_CNT1  800	//CNT1-计数继电器字1
#define	             RW_CNT2  801	//CNT2-计数继电器字2
#define	             RW_CNT3  802	//CNT3-计数继电器字3
#define	             RW_CNT4  803	//CNT4-计数继电器字4
#define	             RW_CNT5  804	//CNT5-计数继电器字5
#define	             RW_CNT6  805	//CNT6-计数继电器字6
#define	             RW_CNT7  806	//CNT7-计数继电器字7
#define	             RW_CNT8  807	//CNT8-计数继电器字7
#define	RELAY_WORD_NUM			808		//继电器总数
...
#define	RCP_RELAY_WORD_NUM			48	

//遥控执行继电器
#define	RCE_RELAY_WORD_START			656	
#define	RCE_RELAY_WORD_NUM			48	

//遥控反校继电器
#define	RCV_RELAY_WORD_START			704	
#define	RCV_RELAY_WORD_NUM			48	

//大于等于继电器
#define	GE_RELAY_WORD_START			752	
#define	GE_RELAY_WORD_NUM			8	

//常数时间继电器
#define	CONST_TIME_RW_START			760	
#define	CONST_TIME_RW_NUM			8	

//发送链接继电器
#define	TXLINK_RW_START			768	
#define	TXLINK_RW_NUM			16	

//接收链接继电器
#define	RXLINK_RW_START			784	
#define	RXLINK_RW_NUM			16	

//电保持中间继
#define	NM_RW_START			800	
#define	NM_RW_NUM			0	

//电保持自保持继
#define	NKEEP_RW_START			800	
#define	NKEEP_RW_NUM			0	

//调试输出继电器
#define	DEBUG_OUT_START			800	
#define	DEBUG_OUT_NUM			0	

//调试输入继电器
#define	DEBUG_IN_START			800	
#define	DEBUG_IN_NUM			0	

//当地控制继电器
#define	LCE_RELAY_WORD_START			800	
#define	LCE_RELAY_WORD_NUM			0	

//计数继电器
#define	CNT_RELAY_WORD_START			800	
