...
BOOL CLcdWndMeasure::Init()
{
	...
	m_BtnLMHram.SetPosition(21,93,216,118,0);
	...
	m_BtnUIAngle.SetPosition(21,126,216,151,0);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnAdress.SetPosition(27,29,222,54,0);
	...
	m_BtnInputSetting.SetPosition(27,62,222,87,0);
	...
	m_BtnBOTime.SetPosition(27,95,222,120,0);
	...
	m_BtnDeviceTime.SetPosition(27,128,222,153,0);
	...
	m_BtnLanguage.SetPosition(27,25,222,50,1);
	...
	m_BtnPassSetting.SetPosition(27,58,222,83,1);
	...
	m_BtnSysParam.SetPosition(27,91,222,116,1);
...
BOOL CLcdWndsyspara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnContrast.SetPosition(20,28,225,53,0);
	...
	m_BtnFVDH.SetPosition(20,61,225,86,0);
	...
	m_BtnDefaultPara.SetPosition(20,94,225,119,0);
	m_BtnDefaultPara.SetTabOrder(3);
	m_pObjList[3] = &m_BtnDefaultPara;
...
//{{HMI_MSG_MAP(CLcdWndsyspara)
	...
	ON_HMIBTN_ENTER(3, OnEnterBtnDefaultPara)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
