...
{		
	...
	WORD wHarmIndex[] = {M_UHAB,M_UHBC,M_UHCA,M_UHA,M_UHB,M_UHC,M_U0, M_ULA, M_ULB,M_ULC,M_IHA,M_IHB,M_IHC, M_ILA, 
		M_ILB,M_ILC,M_I1,M_I2};
	g_AIDlg.DoModal(this, this, hAI, 18, wHarmIndex,DlgCaption);
}
...
{	
	...
	WORD wHarmIndex[] = {M_UHAB,M_UHBC,M_UHCA,M_UHA,M_UHB,M_UHC,M_U0, M_ULA, M_ULB,M_ULC,M_IHA,M_IHB,M_IHC, M_ILA, 
		M_ILB,M_ILC,M_I1,M_I2,M_PA,M_PB,M_PC,M_QA,M_QB,M_QC, M_P,M_Q,M_COSA,M_COSB,M_COSC,M_COS,M_F,M_CUSTOM1};
	g_AIDlg.DoModal(this, this, lAI, 32, wHarmIndex,DlgCaption);
}
...
void CLcdWndMeasure::OnEnterBtnLMHram()
{
	...
	WORD wHarmIndex[] = {M_UHA1,M_UHA2,M_UHA3,M_UHA5, M_UHA7, M_UHA9,M_UHA11,M_UHB1,M_UHB2,M_UHB3,M_UHB5, M_UHB7, 
		...
		M_IHC9,M_IHC11,M_IA1,M_IA2,M_IA3,M_IA5, M_IA7, M_IA9,M_IA11,M_IB1,M_IB2,M_IB3,M_IB5, M_IB7,	M_IB9,M_IB11,
		M_IC1,M_IC2,M_IC3,M_IC5, M_IC7, M_IC9,M_IC11};
	g_AIDlg.DoModal(this, this, lAI, 63, wHarmIndex,DlgCaption);
}
