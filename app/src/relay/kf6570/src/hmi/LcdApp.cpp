...
BOOL CLcdWndMainMenu::Init()
{
	...
	m_Btntest.SetPosition(15,35,110,70,1);
	...
	m_BtnStatus.SetPosition(124,35,219,70,1);
	...
	m_BtnAbout.SetPosition(15,78,110,113,1);
...
BOOL CLcdWndMeasure::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnHMeasure.SetPosition(23,28,218,53,0);
	...
	m_BtnLMeasure.SetPosition(23,60,218,85,0);
	...
	m_BtnLMHram.SetPosition(23,93,218,118,0);
	m_BtnLMHram.SetTabOrder(3);
	m_pObjList[3] = &m_BtnLMHram;
	m_BtnLMHram.SetFont(0);
	m_BtnLMHram.SetOwner(this);
	m_BtnLMHram.SetCaption(tr("二次侧谐波值"));
	m_BtnLMHram.SetHaveEnterFun(TRUE);
	m_BtnLMHram.SetEnterWnd(NULL);
	m_BtnUIAngle.SetPosition(23,126,218,151,0);
	m_BtnUIAngle.SetTabOrder(4);
	m_pObjList[4] = &m_BtnUIAngle;
	m_BtnUIAngle.SetFont(16);
	m_BtnUIAngle.SetOwner(this);
	m_BtnUIAngle.SetCaption(tr("电压电流相位"));
	m_BtnUIAngle.SetHaveEnterFun(TRUE);
	m_BtnUIAngle.SetEnterWnd(NULL);
	m_BtnKilowatt.SetPosition(23,28,218,53,1);
...
//{{HMI_MSG_MAP(CLcdWndMeasure)
	...
	ON_HMIBTN_ENTER(3, OnEnterBtnLMHram)
	ON_HMIBTN_ENTER(4, OnEnterBtnUIAngle)
...
BOOL CLcdWndASModify::Init()
{
	...
	m_StaticASSymbol.SetPosition(14,40,98,55,0);
	...
	m_StaticUpLimit.SetPosition(14,134,177,149,0);
...
BOOL CLcdWndReport::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnActionReport.SetPosition(27,30,202,55,0);
	...
	m_BtnAlarmReport.SetPosition(27,60,202,85,0);
	...
	m_BtnStartReport.SetPosition(27,90,202,115,0);
	...
	m_BtnSoe.SetPosition(27,121,202,146,0);
	...
	m_BtnOperation.SetPosition(27,28,202,53,1);
...
BOOL CLcdWndSettingQueryAreaNumInput::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditAreaNum.SetPosition(150,79,180,99,0);
	...
	m_Static4883.SetPosition(24,79,129,99,0);
	...
	m_Static4915.SetPosition(24,44,139,69,0);
	...
	m_StaticNowAreaNum.SetPosition(150,44,180,59,0);
...
BOOL CLcdWndSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSettingQuery.SetPosition(25,27,220,52,0);
	...
	m_BtnsettingModify.SetPosition(25,60,220,85,0);
	...
	m_BtnSettingCopy.SetPosition(25,93,220,118,0);
	...
	m_BtnsettingExChg.SetPosition(25,126,220,151,0);
	...
	m_BtnASQuery.SetPosition(25,28,220,53,1);
	...
	m_BtnASModify.SetPosition(25,61,220,86,1);
...
BOOL CLcdWndSettingModify::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditSettingData.SetPosition(101,40,166,60,0);
	...
	m_StaticSymbol.SetPosition(16,41,61,61,0);
	...
	m_StaticName.SetPosition(17,74,197,99,0);
	...
	m_StaticUpLimit.SetPosition(17,101,152,121,0);
	m_StaticUpLimit.SetTabOrder(-6);
	m_pObjList[6] = &m_StaticUpLimit;
	m_StaticUpLimit.SetFont(16);
	m_StaticUpLimit.SetOwner(this);
	...
	m_StaticDownLimit.SetPosition(17,129,177,149,0);
	...
	m_StaticDownLimit.SetDataSource(-1,0);
	m_StaticDownLimit.SetTimer(0);
	m_StaticUnit.SetPosition(184,41,204,61,0);
	...
	m_ComboSettingComb.SetPosition(136,70,221,95,0);
...
BOOL CLcdWndSettingSave::Init()
{
	...
	m_Static4697.SetPosition(32,37,197,62,0);
	...
	m_Static4698.SetPosition(32,61,197,86,0);
	...
	m_Static4699.SetPosition(32,92,197,112,0);
...
BOOL CLcdWndSettingSwitch::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditAreaNum.SetPosition(143,89,193,109,0);
	m_EditAreaNum.SetTabOrder(1);
	m_pObjList[1] = &m_EditAreaNum;
	m_EditAreaNum.SetFont(16);
	m_EditAreaNum.SetOwner(this);
	...
	m_EditAreaNum.SetHaveEnterFun(FALSE);
	m_EditAreaNum.SetHaveAddSubFun(FALSE);
	m_Static4702.SetPosition(22,54,127,74,0);
	...
	m_Static4706.SetPosition(23,90,138,110,0);
	...
	m_StaticNowAreaNum.SetPosition(143,55,173,75,0);
...
BOOL CLcdWndSettingCopy::Init()
{
	...
	SetLRFun(1);
	SetLROffset(1);
	m_EditSoureAreaNum.SetPosition(142,44,192,64,0);
	...
	m_EditDstStartAreaNum.SetPosition(55,97,105,117,0);
	...
	m_EditDstEndAreaNum.SetPosition(55,121,105,141,0);
	...
	m_Static4710.SetPosition(15,28,225,48,0);
	...
	m_Static4711.SetPosition(15,74,220,94,0);
	...
	m_Static4885.SetPosition(15,97,70,112,0);
	...
	m_Static4886.SetPosition(116,97,176,112,0);
	...
	m_Static5350.SetPosition(117,123,142,143,0);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnAdress.SetPosition(23,29,218,54,0);
	...
	m_BtnInputSetting.SetPosition(23,62,218,87,0);
	...
	m_BtnBOTime.SetPosition(23,95,218,120,0);
	...
	m_BtnCI.SetPosition(23,128,218,153,0);
	...
	m_BtnDeviceTime.SetPosition(23,25,218,50,1);
	...
	m_BtnLanguage.SetPosition(23,58,218,83,1);
	...
	m_BtnPassSetting.SetPosition(23,91,218,116,1);
	...
	m_BtnSysParam.SetPosition(23,124,218,149,1);
...
BOOL CLcdWndCIBase::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditIntKW1.SetPosition(131,31,216,51,0);
	...
	m_EditIntKW2.SetPosition(131,65,216,85,0);
	...
	m_StaticStaticIntKW1.SetPosition(22,31,112,56,0);
	m_StaticStaticIntKW1.SetTabOrder(-3);
	m_pObjList[3] = &m_StaticStaticIntKW1;
	...
	m_StaticStaticIntKW2.SetPosition(22,65,112,90,0);
	m_StaticStaticIntKW2.SetTabOrder(-4);
	m_pObjList[4] = &m_StaticStaticIntKW2;
...
BOOL CLcdWndCIPara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnKWH.SetPosition(28,32,213,57,0);
	m_BtnKWH.SetTabOrder(1);
	m_pObjList[1] = &m_BtnKWH;
	m_BtnKWH.SetFont(16);
	m_BtnKWH.SetOwner(this);
	m_BtnKWH.SetCaption(tr("积分电度计算"));
	m_BtnKWH.SetHaveEnterFun(TRUE);
	m_BtnKWH.SetEnterWnd(NULL);
	m_BtnCIBase.SetPosition(28,63,213,88,0);
	m_BtnCIBase.SetTabOrder(2);
	m_pObjList[2] = &m_BtnCIBase;
...
//{{HMI_MSG_MAP(CLcdWndCIPara)
	ON_HMIBTN_ENTER(1, OnEnterBtnKWH)
	ON_HMIBTN_ENTER(2, OnEnterBtnCIBase)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndtime::Init()
{
	...
	m_EditHour.SetPosition(26,104,66,124,0);
	...
	m_EditMinute.SetPosition(93,104,133,124,0);
	...
	m_EditSecond.SetPosition(161,104,201,124,0);
	...
	m_Static4739.SetPosition(26,83,66,103,0);
	...
	m_Static4740.SetPosition(93,83,133,103,0);
	...
	m_Static4741.SetPosition(161,83,201,103,0);
...
BOOL CLcdWndInputSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSoeProperty.SetPosition(16,31,221,56,0);
	...
	m_BtnBIFilter.SetPosition(16,62,221,87,0);
	...
	m_BtnBiNo.SetPosition(16,93,221,118,0);
...
BOOL CLcdWndTest::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnOutputTest.SetPosition(26,27,216,52,0);
	...
	m_BtnLenTest.SetPosition(26,60,216,85,0);
	...
	m_BtnReportTest.SetPosition(26,93,216,118,0);
	...
	m_BtnManualREC.SetPosition(26,126,216,151,0);
	...
	m_BtnfactorySet.SetPosition(26,30,216,55,1);
	m_BtnfactorySet.SetTabOrder(5);
	m_pObjList[5] = &m_BtnfactorySet;
	m_BtnfactorySet.SetFont(0);
...
BOOL CLcdWndfactorySet::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnManualCoef.SetPosition(25,32,215,57,0);
	...
	m_BtnAutoCoef.SetPosition(25,64,215,89,0);
...
BOOL CLcdWndManualREC::Init()
{
	...
	m_Staticstatic2.SetPosition(8,73,223,98,0);
	...
	m_Staticstatic3.SetPosition(8,105,223,130,0);
...
BOOL CLcdWndOutputTest::Init()
{
	...
	m_EditOutputNum.SetValueRange(32,1);
	...
	m_EditOutputTime.SetPosition(119,60,154,80,0);
...
BOOL CLcdWndAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnCAN.SetPosition(23,28,218,53,0);
	...
	m_BtnETH.SetPosition(23,61,218,86,0);
	...
	m_BtnPortPara.SetPosition(23,94,218,119,0);
	...
	m_BtnSerialSet.SetPosition(23,127,218,152,0);
...
BOOL CLcdWndEthadd::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnetha.SetPosition(32,32,207,57,0);
	...
	m_Btnehtb.SetPosition(32,66,207,91,0);
	m_Btnehtb.SetTabOrder(2);
	m_pObjList[2] = &m_Btnehtb;
	m_Btnehtb.SetFont(16);
	m_Btnehtb.SetOwner(this);
	m_Btnehtb.SetCaption(tr("以太网B"));
	m_Btnehtb.SetHaveEnterFun(TRUE);
	m_Btnehtb.SetEnterWnd(NULL);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(2);
...
//{{HMI_MSG_MAP(CLcdWndEthadd)
	...
	ON_HMIBTN_ENTER(2, OnEnterBtnehtb)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndCANAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnenter.SetPosition(41,113,101,138,0);
	...
	m_BtnESC.SetPosition(128,113,188,138,0);
	...
	m_EditCANA.SetPosition(102,47,147,72,0);
	...
	m_Static5455.SetPosition(15,51,90,76,0);
	m_Static5455.SetTabOrder(-4);
	m_pObjList[4] = &m_Static5455;
	m_Static5455.SetFont(16);
	m_Static5455.SetOwner(this);
	m_Static5455.SetCaption(tr("装置地址:"));
	m_Static5455.SetDataSource(-1,0);
	m_Static5455.SetTimer(0);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(4);
...
BOOL CLcdWndPassChange::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnChgCommonPass.SetPosition(28,38,213,63,0);
	...
	m_BtnChgSettingPass.SetPosition(28,71,213,96,0);
...
BOOL CLcdWndSettingChgAreaNumInput::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditInputAreaNum.SetPosition(160,111,195,131,0);
	...
	m_Static4899.SetPosition(19,113,149,133,0);
	...
	m_Static4917.SetPosition(18,68,138,83,0);
	...
	m_StaticNowAreaNum.SetPosition(159,66,214,86,0);
	m_StaticNowAreaNum.SetTabOrder(-2);
	m_pObjList[2] = &m_StaticNowAreaNum;
	m_StaticNowAreaNum.SetFont(16);
	m_StaticNowAreaNum.SetOwner(this);
...
BOOL CLcdWndsyspara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnContrast.SetPosition(18,28,223,53,0);
	...
	m_BtnFVDH.SetPosition(18,61,223,86,0);
	...
	m_BtnIRGBType.SetPosition(18,95,223,120,0);
	...
	m_BtnDefaultPara.SetPosition(18,127,223,152,0);
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(43,31,198,56,0);
	...
	m_BtnProtocol.SetPosition(43,63,198,88,0);
...
BOOL CLcdWndWStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDevStatus.SetPosition(24,31,214,56,0);
	...
	m_BtnComStatus.SetPosition(24,63,214,88,0);
...
void CLcdApp::Init()
{
	...
	m_pWndList[22] = &m_WndCIBase;
	m_pWndList[23] = &m_WndCIPara;
	...
	m_pWndList[29] = &m_WndCF;
	m_pWndList[30] = &m_WndTest;
	m_pWndList[31] = &m_WndfactorySet;
	m_pWndList[32] = &m_WndManualREC;
	m_pWndList[33] = &m_WndOutputTest;
	m_pWndList[34] = &m_WndLanTest;
	m_pWndList[35] = &m_WndReportTest;
	m_pWndList[36] = &m_WndAddress;
	m_pWndList[37] = &m_WndEthadd;
	m_pWndList[38] = &m_WndCANAddress;
	m_pWndList[39] = &m_WndPassChange;
	m_pWndList[40] = &m_WndSettingChgAreaNumInput;
	m_pWndList[41] = &m_Wndsyspara;
	m_pWndList[42] = &m_WndSettingSwitchConfirm;
	m_pWndList[43] = &m_WndPortStatus;
	m_pWndList[44] = &m_WndWStatus;
