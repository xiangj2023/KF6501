...
#define MEASURE_COUNT     94    //测量值个数
#define MEASURE_BUF_SIZE     376    //测量值缓冲区大小
...
#define SW_BUF_ADDR 	 (RELAY_RAM_ADDR_BASE + 444)
...
#define CFG_BUF_ADDR 	 (RELAY_RAM_ADDR_BASE + 450)
...
#define RS_BUF_ADDR 	 (RELAY_RAM_ADDR_BASE + 456)
...
#define AS_BUF_ADDR 	 (RELAY_RAM_ADDR_BASE + 716)
...
#define CF_BUF_ADDR 	 (RELAY_RAM_ADDR_BASE + 772)
