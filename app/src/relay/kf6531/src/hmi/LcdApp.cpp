...
BOOL CLcdWndMainMenu::Init()
{
	...
	SetCaption(tr("KF6531电铁变压器后备保护装置"));
	SetEscWnd(NULL);
	SetEnterWnd(NULL);
	SetUDFun(0);
	SetUDOffset(2);
	...
	m_Btntest.SetPosition(15,36,110,71,1);
	...
	m_BtnStatus.SetPosition(125,36,220,71,1);
...
BOOL CLcdWndMeasure::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnHMe.SetPosition(28,30,218,55,0);
	...
	m_BtnHMeasure.SetPosition(28,62,218,87,0);
	...
	m_BtnLMe.SetPosition(28,94,218,119,0);
	...
	m_BtnLMeasure.SetPosition(28,126,218,151,0);
	m_BtnLMeasure.SetTabOrder(4);
	m_pObjList[4] = &m_BtnLMeasure;
	m_BtnLMeasure.SetFont(0);
	m_BtnLMeasure.SetOwner(this);
	m_BtnLMeasure.SetCaption(tr("二次侧保护值"));
...
//{{HMI_MSG_MAP(CLcdWndMeasure)
	...
	ON_HMIBTN_ENTER(4, OnEnterBtnLMeasure)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndASModify::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditAsInput.SetPosition(37,67,172,87,0);
	...
	m_StaticAsUnit.SetPosition(185,68,220,88,0);
	...
	m_StaticDownLimit.SetPosition(130,134,220,149,0);
	...
	m_StaticUpLimit.SetPosition(20,134,110,149,0);
	...
	m_StaticAsName.SetPosition(23,103,178,123,0);
	...
	m_ComboAsCombo.SetPosition(101,29,201,54,0);
...
BOOL CLcdWndReport::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnActionReport.SetPosition(18,28,213,53,0);
	...
	m_BtnAlarmReport.SetPosition(18,61,213,86,0);
	...
	m_BtnStartReport.SetPosition(18,94,213,119,0);
	...
	m_BtnSoe.SetPosition(18,127,213,152,0);
	...
	m_BtnOperation.SetPosition(18,34,213,59,1);
...
BOOL CLcdWndSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSettingQuery.SetPosition(15,28,220,53,0);
	...
	m_BtnsettingModify.SetPosition(15,61,220,86,0);
	m_BtnsettingModify.SetTabOrder(2);
	m_pObjList[2] = &m_BtnsettingModify;
	m_BtnsettingModify.SetFont(16);
	...
	m_BtnSettingCopy.SetPosition(15,94,220,119,0);
	...
	m_BtnsettingExChg.SetPosition(15,127,220,152,0);
	...
	m_BtnASQuery.SetPosition(15,30,220,55,1);
	...
	m_BtnASModify.SetPosition(15,63,220,88,1);
...
BOOL CLcdWndSettingModify::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditSettingData.SetPosition(37,65,167,85,0);
	...
	m_StaticSymbol.SetPosition(23,40,68,60,0);
	...
	m_StaticName.SetPosition(22,103,187,123,0);
	...
	m_StaticUpLimit.SetPosition(118,130,208,150,0);
	m_StaticUpLimit.SetTabOrder(-6);
	m_pObjList[6] = &m_StaticUpLimit;
	m_StaticUpLimit.SetFont(16);
	m_StaticUpLimit.SetOwner(this);
	...
	m_StaticDownLimit.SetPosition(20,130,110,150,0);
	...
	m_StaticDownLimit.SetDataSource(-1,0);
	m_StaticDownLimit.SetTimer(0);
	m_StaticUnit.SetPosition(175,65,195,85,0);
	...
	m_ComboSettingComb.SetPosition(117,31,202,56,0);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnAdress.SetPosition(17,28,222,53,0);
	...
	m_BtnInputSetting.SetPosition(17,61,222,86,0);
	...
	m_BtnBOTime.SetPosition(17,94,222,119,0);
	...
	m_BtnDeviceTime.SetPosition(17,127,222,152,0);
	...
	m_BtnLanguage.SetPosition(18,34,223,59,1);
	...
	m_BtnPassSetting.SetPosition(18,67,223,92,1);
	...
	m_BtnSysParam.SetPosition(18,100,223,125,1);
...
BOOL CLcdWndtime::Init()
{
	...
	m_Static4737.SetPosition(26,30,66,50,0);
	...
	m_Static4738.SetPosition(93,30,133,50,0);
	...
	m_Static4739.SetPosition(26,87,71,107,0);
	...
	m_Static4740.SetPosition(93,87,138,107,0);
	...
	m_Static4741.SetPosition(161,87,206,107,0);
	...
	m_Static4742.SetPosition(161,30,201,50,0);
...
BOOL CLcdWndInputSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSoeProperty.SetPosition(24,37,214,62,0);
	...
	m_BtnBIFilter.SetPosition(24,70,214,95,0);
	...
	m_BtnBiNo.SetPosition(24,103,214,128,0);
...
BOOL CLcdWndTest::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnOutputTest.SetPosition(17,31,222,56,0);
	...
	m_BtnLenTest.SetPosition(17,62,222,87,0);
	...
	m_BtnReportTest.SetPosition(17,93,222,118,0);
	...
	m_BtnManualREC.SetPosition(17,124,222,149,0);
	...
	m_BtnfactorySet.SetPosition(17,31,222,56,1);
...
BOOL CLcdWndAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnCAN.SetPosition(22,27,212,52,0);
	...
	m_BtnETH.SetPosition(22,58,212,83,0);
	...
	m_BtnPortPara.SetPosition(22,89,212,114,0);
	...
	m_BtnSerialSet.SetPosition(22,120,212,145,0);
...
BOOL CLcdWndEthadd::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnetha.SetPosition(23,35,223,60,0);
	...
	m_Btnehtb.SetPosition(23,69,223,94,0);
...
BOOL CLcdWndCANAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnenter.SetPosition(35,113,95,138,0);
	...
	m_BtnESC.SetPosition(131,113,191,138,0);
	...
	m_EditCANA.SetPosition(102,44,147,69,0);
	...
	m_Static5430.SetPosition(19,50,94,70,0);
	m_Static5430.SetTabOrder(-4);
	m_pObjList[4] = &m_Static5430;
	m_Static5430.SetFont(16);
	m_Static5430.SetOwner(this);
	m_Static5430.SetCaption(tr("设备地址:"));
	m_Static5430.SetDataSource(-1,0);
	m_Static5430.SetTimer(0);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(4);
...
BOOL CLcdWndPassChange::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnChgCommonPass.SetPosition(18,38,213,63,0);
	...
	m_BtnChgSettingPass.SetPosition(18,69,213,94,0);
...
BOOL CLcdWndsyspara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnContrast.SetPosition(14,28,219,53,0);
	...
	m_BtnFVDH.SetPosition(14,61,219,86,0);
	...
	m_BtnIRGBType.SetPosition(14,91,219,116,0);
	...
	m_BtnDefaultPara.SetPosition(14,122,219,147,0);
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(43,32,198,57,0);
	...
	m_BtnProtocol.SetPosition(43,62,198,87,0);
...
BOOL CLcdWndWStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDevStatus.SetPosition(20,37,220,62,0);
	...
	m_BtnComStatus.SetPosition(20,69,220,94,0);
