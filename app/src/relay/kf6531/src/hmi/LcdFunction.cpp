...
{		
	...
	WORD whAIIndex[] = {RM_UHAB,RM_UHBC,RM_UHCA,RM_UHA,RM_UHB,RM_UHC,RM_U0,\
		RM_ULA,RM_ULB,RM_IHA,RM_IHB,RM_IHC,RM_I0,RM_IJX,RM_ILA,RM_ILB,RM_IL1,RM_IL2,RM_IL3,RM_IL4};	
	g_AIDlg.DoModal(this, this, phAI,20,whAIIndex,DlgCaption);
}
...
{	
	...
	WORD whAIIndex[] = {RM_UHAB,RM_UHBC,RM_UHCA,RM_UHA,RM_UHB,RM_UHC,RM_U0,\
		RM_ULA,RM_ULB,RM_ULAB,RM_IHA,RM_IHB,RM_IHC,RM_I0,RM_IJX,RM_ILA,RM_ILB,RM_IL1,RM_IL2,RM_IL3,RM_IL4};	
	g_AIDlg.DoModal(this, this, plAI,21,whAIIndex,DlgCaption);
}
void CLcdWndMeasure::OnEnterBtnHMe()
{
	char DlgCaption[64];
	sprintf(DlgCaption, tr("一次侧测量值\n"));	
	WORD whAIIndex[] = {M_UHA,M_UHB,M_UHC,M_U0,M_ULA,M_ULB,M_IHA,\
		M_IHB,M_IHC,M_I0,M_IJX,M_ILA,M_ILB,M_IL1,M_IL2,M_IL3,M_IL4};	
	g_AIDlg.DoModal(this, this, hAI,17,whAIIndex,DlgCaption);
}
...
void CLcdWndMeasure::OnEnterBtnLMe()
{
	...
	WORD whAIIndex[] = {M_UHA,M_UHB,M_UHC,M_U0,M_ULA,M_ULB,M_IHA,\
		M_IHB,M_IHC,M_I0,M_IJX,M_ILA,M_ILB,M_IL1,M_IL2,M_IL3,M_IL4};	
	g_AIDlg.DoModal(this, this, lAI,17,whAIIndex,DlgCaption);
}
...
void CLcdWndASModify::OnWndEnter()
{
	...
	HMIMsgBox(tr("修改公用定值"),  tr("确定要公用辅助定值?"),  this, this, HMI_MB_OKCANCEL, pfn);
