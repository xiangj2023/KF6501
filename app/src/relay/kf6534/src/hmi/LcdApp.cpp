...
BOOL CLcdWndMainMenu::Init()
{
	...
	SetCaption(tr("KF6534电铁AT保护测控装置"));
	SetEscWnd(NULL);
	SetEnterWnd(NULL);
	SetUDFun(0);
	SetUDOffset(2);
	...
	m_BtnStatus.SetPosition(125,35,220,70,1);
	...
	m_BtnAbout.SetPosition(15,77,110,112,1);
...
BOOL CLcdWndMeasure::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnHMeasure.SetPosition(21,33,216,58,0);
	...
	m_BtnLMeasure.SetPosition(21,65,216,90,0);
	...
	m_BtnPML.SetPosition(21,98,216,123,0);
...
BOOL CLcdWndASModify::Init()
{
	...
	m_StaticDownLimit.SetPosition(14,111,219,126,0);
	...
	m_StaticUpLimit.SetPosition(14,135,219,150,0);
...
BOOL CLcdWndReport::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnActionReport.SetPosition(18,28,218,53,0);
	...
	m_BtnAlarmReport.SetPosition(18,61,218,86,0);
	...
	m_BtnStartReport.SetPosition(18,94,218,119,0);
	...
	m_BtnSoe.SetPosition(18,127,218,152,0);
	...
	m_BtnOperation.SetPosition(18,30,218,55,1);
...
BOOL CLcdWndSettingQueryAreaNumInput::Init()
{
	...
	m_Static4883.SetPosition(9,79,169,99,0);
	...
	m_Static4915.SetPosition(9,44,169,64,0);
...
BOOL CLcdWndSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSettingQuery.SetPosition(12,28,227,53,0);
	...
	m_BtnsettingModify.SetPosition(12,61,227,86,0);
	...
	m_BtnSettingCopy.SetPosition(12,94,227,119,0);
	...
	m_BtnsettingExChg.SetPosition(12,127,227,152,0);
	...
	m_BtnASQuery.SetPosition(12,27,227,52,1);
	...
	m_BtnASModify.SetPosition(12,60,227,85,1);
...
BOOL CLcdWndSettingModify::Init()
{
	...
	m_StaticUpLimit.SetPosition(17,111,207,131,0);
	m_StaticUpLimit.SetTabOrder(-6);
	m_pObjList[6] = &m_StaticUpLimit;
	m_StaticUpLimit.SetFont(16);
	m_StaticUpLimit.SetOwner(this);
	...
	m_StaticDownLimit.SetPosition(17,135,207,155,0);
...
BOOL CLcdWndSettingSave::Init()
{
	...
	m_Static4697.SetPosition(12,37,212,57,0);
	...
	m_Static4698.SetPosition(12,65,212,85,0);
	...
	m_Static4699.SetPosition(12,92,212,112,0);
...
BOOL CLcdWndSettingSwitch::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditAreaNum.SetPosition(173,89,223,109,0);
	m_EditAreaNum.SetTabOrder(1);
	m_pObjList[1] = &m_EditAreaNum;
	m_EditAreaNum.SetFont(16);
	m_EditAreaNum.SetOwner(this);
	...
	m_EditAreaNum.SetHaveEnterFun(FALSE);
	m_EditAreaNum.SetHaveAddSubFun(FALSE);
	m_Static4702.SetPosition(12,54,162,74,0);
	...
	m_Static4706.SetPosition(12,90,162,110,0);
	...
	m_StaticNowAreaNum.SetPosition(173,55,203,75,0);
...
BOOL CLcdWndSettingCopy::Init()
{
	...
	SetLRFun(1);
	SetLROffset(1);
	m_EditSoureAreaNum.SetPosition(168,41,218,61,0);
	...
	m_EditDstStartAreaNum.SetPosition(82,95,132,115,0);
	...
	m_EditDstEndAreaNum.SetPosition(82,126,132,146,0);
	...
	m_Static4710.SetPosition(16,41,141,61,0);
	...
	m_Static4711.SetPosition(16,74,216,94,0);
	...
	m_Static5514.SetPosition(152,95,212,115,0);
	m_Static5514.SetTabOrder(-4);
	m_pObjList[4] = &m_Static5514;
	m_Static5514.SetFont(16);
	m_Static5514.SetOwner(this);
	m_Static5514.SetCaption(tr("区"));
	m_Static5514.SetDataSource(-1,0);
	m_Static5514.SetTimer(0);
	m_Static4885.SetPosition(22,95,67,110,0);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnAdress.SetPosition(13,28,223,53,0);
	...
	m_BtnInputSetting.SetPosition(13,61,223,86,0);
	...
	m_BtnBOTime.SetPosition(13,94,223,119,0);
	...
	m_BtnDeviceTime.SetPosition(13,127,223,152,0);
	...
	m_BtnLanguage.SetPosition(13,28,223,53,1);
	...
	m_BtnPassSetting.SetPosition(13,61,223,86,1);
	...
	m_BtnSysParam.SetPosition(13,94,223,119,1);
...
BOOL CLcdWndtime::Init()
{
	...
	m_EditMonth.SetPosition(93,61,133,81,0);
	...
	m_EditHour.SetPosition(26,116,66,136,0);
	...
	m_EditMinute.SetPosition(93,116,133,136,0);
	...
	m_EditSecond.SetPosition(161,116,201,136,0);
	...
	m_Static4737.SetPosition(26,32,66,52,0);
	...
	m_Static4738.SetPosition(93,32,133,52,0);
	...
	m_Static4739.SetPosition(26,92,66,112,0);
	...
	m_Static4740.SetPosition(93,92,133,112,0);
	...
	m_Static4741.SetPosition(161,92,201,112,0);
	...
	m_Static4742.SetPosition(161,32,201,52,0);
...
BOOL CLcdWndInputSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSoeProperty.SetPosition(23,28,218,53,0);
	...
	m_BtnBIFilter.SetPosition(23,61,218,86,0);
	...
	m_BtnBiNo.SetPosition(23,94,218,119,0);
...
BOOL CLcdWndTest::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnOutputTest.SetPosition(13,28,228,53,0);
	...
	m_BtnLenTest.SetPosition(13,61,228,86,0);
	...
	m_BtnReportTest.SetPosition(13,94,228,119,0);
	...
	m_BtnManualREC.SetPosition(13,127,228,152,0);
	...
	m_BtnfactorySet.SetPosition(13,26,228,51,1);
...
BOOL CLcdWndManualREC::Init()
{
	...
	m_Staticstatic3.SetPosition(8,95,223,120,0);
...
BOOL CLcdWndOutputTest::Init()
{
	...
	SetLRFun(-1);
	SetLROffset(1);
	m_EditOutputNum.SetPosition(158,33,193,53,0);
	...
	m_EditOutputNum.SetValueRange(28,1);
	...
	m_EditOutputTime.SetPosition(158,60,193,80,0);
	...
	m_StaticOutputName.SetPosition(13,97,213,112,0);
	...
	m_Static4771.SetPosition(12,34,137,54,0);
	...
	m_Static4773.SetPosition(12,62,137,82,0);
	...
	m_Static4775.SetPosition(198,60,223,80,0);
	...
	m_Static4776.SetPosition(13,123,213,138,0);
...
BOOL CLcdWndLanTest::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnStart.SetPosition(37,114,97,139,0);
	...
	m_BtnCancel.SetPosition(131,114,191,139,0);
	m_BtnCancel.SetTabOrder(2);
	m_pObjList[2] = &m_BtnCancel;
	...
	m_Static4779.SetPosition(13,39,223,59,0);
	...
	m_Static4780.SetPosition(13,61,223,81,0);
...
BOOL CLcdWndReportTest::Init()
{
	...
	m_Static4785.SetPosition(15,85,210,115,0);
...
BOOL CLcdWndAddress::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnCAN.SetPosition(16,28,226,53,0);
	...
	m_BtnCAN.SetEnterWnd((CHmiWnd*)&(CLcdApp::m_WndCANA));
	m_BtnETH.SetPosition(16,61,226,86,0);
	...
	m_BtnPortpara.SetPosition(16,94,226,119,0);
	...
	m_BtnSerialset.SetPosition(16,127,226,152,0);
...
//************窗口CANA: 设备地址*******************
CLcdWndCANA::~CLcdWndCANA()
{
}
CLcdWndCANA::CLcdWndCANA()
{
}
BOOL CLcdWndCANA::Init()
{
	SetClassName("CLcdWndCANA");
	SetCaption(tr("设备地址"));
	SetEscWnd((CHmiWnd*)&(CLcdApp::m_WndAddress));
	SetEnterWnd(NULL);
	SetUDFun(0);
	...
	SetLRFun(0);
	SetLROffset(1);
	m_Btnenter.SetPosition(44,111,104,136,0);
	...
	m_BtnESC.SetPosition(137,111,197,136,0);
	...
	m_EditCANA.SetPosition(161,44,206,69,0);
	...
	m_Static5464.SetPosition(25,44,140,69,0);
	m_Static5464.SetTabOrder(-4);
	m_pObjList[4] = &m_Static5464;
	m_Static5464.SetFont(16);
	m_Static5464.SetOwner(this);
	m_Static5464.SetCaption(tr("设备地址:"));
	m_Static5464.SetDataSource(-1,0);
	m_Static5464.SetTimer(0);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(4);
...
BEGIN_HMIMESSAGE_MAP(CLcdWndCANA,CHmiWnd)
//{{HMI_MSG_MAP(CLcdWndCANA)
...
BOOL CLcdWndPassChange::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnChgCommonPass.SetPosition(15,38,230,63,0);
	...
	m_BtnChgSettingPass.SetPosition(15,69,230,94,0);
...
BOOL CLcdWndSettingChgAreaNumInput::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_EditInputAreaNum.SetPosition(183,79,218,99,0);
	...
	m_Static4899.SetPosition(13,79,173,99,0);
	...
	m_Static4917.SetPosition(13,47,173,67,0);
	...
	m_StaticNowAreaNum.SetPosition(183,47,218,67,0);
	m_StaticNowAreaNum.SetTabOrder(-2);
	m_pObjList[2] = &m_StaticNowAreaNum;
	m_StaticNowAreaNum.SetFont(16);
	m_StaticNowAreaNum.SetOwner(this);
...
BOOL CLcdWndsyspara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnContrast.SetPosition(20,28,220,53,0);
	...
	m_BtnFVDH.SetPosition(20,61,220,86,0);
	...
	m_BtnIRBGType.SetPosition(20,93,220,118,0);
	m_BtnIRBGType.SetTabOrder(3);
	m_pObjList[3] = &m_BtnIRBGType;
	m_BtnIRBGType.SetFont(16);
	m_BtnIRBGType.SetOwner(this);
	m_BtnIRBGType.SetCaption(tr("GPS格式设置"));
	m_BtnIRBGType.SetHaveEnterFun(TRUE);
	m_BtnIRBGType.SetEnterWnd(NULL);
	m_BtnDefaultPara.SetPosition(20,125,220,150,0);
...
//{{HMI_MSG_MAP(CLcdWndsyspara)
	...
	ON_HMIBTN_ENTER(3, OnEnterBtnIRBGType)
...
BOOL CLcdWndSettingSwitchConfirm::Init()
{
	...
	m_BtnCancel.SetHaveEnterFun(FALSE);
	m_BtnCancel.SetEnterWnd((CHmiWnd*)&(CLcdApp::m_WndSetting));
	m_Static4920.SetPosition(15,44,145,64,0);
	...
	m_Static44444.SetPosition(15,75,145,95,0);
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(40,32,200,57,0);
	...
	m_BtnProtocol.SetPosition(40,64,200,89,0);
...
BOOL CLcdWndWStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDevStatus.SetPosition(21,28,221,53,0);
	...
	m_BtnComStatus.SetPosition(21,61,221,86,0);
