...
///////////////////////////////////////////////
class CLcdWndCANA : public CHmiWnd
{
public:
	CLcdWndCANA();
	BOOL Init();
	...
	CHmiButton m_BtnESC;
	CHmiEdit m_EditCANA;
	CHmiDataStatic m_Static5464;
	CHmiObj* m_pObjList[5];
	DECLARE_HMIMESSAGE_MAP() 
//{{begin of user function and memeber(CLcdWndCANA)
//手动添加的成员变量放在括号之间
	BOOL OnWndInit();

//}}end of user function and memeber(CLcdWndCANA)
};
