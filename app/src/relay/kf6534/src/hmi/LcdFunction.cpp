...
void CLcdWndMeasure::OnEnterBtnPML()
{
	...
	WORD whAIIndex[] = {RM_UP1,RM_UP2,RM_UP3,RM_UP4,RM_UP5,RM_UP6,RM_UP7,RM_UP8,RM_IP1,RM_IP2,RM_IP3,RM_IP4,RM_IP5,RM_IP6,RM_IP7,RM_IP8,RM_IC1,RM_IC2}; 
	g_AIDlg.DoModal(this, this, plAI,18,whAIIndex,DlgCaption);
}
...
void CLcdWndsyspara::OnEnterBtnIRBGType()
{
