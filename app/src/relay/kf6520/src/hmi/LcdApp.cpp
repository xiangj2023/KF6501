...
BOOL CLcdWndMainMenu::Init()
{
	...
	SetCaption(tr("KF6520电铁馈线保护测控装置"));
	SetEscWnd(NULL);
	SetEnterWnd(NULL);
	SetUDFun(0);
	SetUDOffset(2);
	...
	m_BtnAbout.SetPosition(15,76,110,111,1);
...
BOOL CLcdWndMeasure::Init()
{
	...
	m_BtnLHarmonic.SetPosition(21,127,216,152,0);
	m_BtnLHarmonic.SetTabOrder(4);
	m_pObjList[4] = &m_BtnLHarmonic;
	m_BtnLHarmonic.SetFont(16);
	m_BtnLHarmonic.SetOwner(this);
	m_BtnLHarmonic.SetCaption(tr("二次侧谐波值"));
	m_BtnLHarmonic.SetHaveEnterFun(TRUE);
	m_BtnLHarmonic.SetEnterWnd(NULL);
	m_BtnKilowatt.SetPosition(21,31,216,56,1);
	...
	m_BtnLoadValue.SetPosition(21,64,216,89,1);
	m_BtnLoadValue.SetTabOrder(6);
	m_pObjList[6] = &m_BtnLoadValue;
	m_BtnLoadValue.SetFont(16);
	m_BtnLoadValue.SetOwner(this);
	m_BtnLoadValue.SetCaption(tr("负荷监测"));
	m_BtnLoadValue.SetHaveEnterFun(TRUE);
	m_BtnLoadValue.SetEnterWnd((CHmiWnd*)&(CLcdApp::m_WndLoad));
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(2);
	SetObjNum(6);
...
//{{HMI_MSG_MAP(CLcdWndMeasure)
	...
	ON_HMIBTN_ENTER(4, OnEnterBtnLHarmonic)
	ON_HMIBTN_ENTER(5, OnEnterBtnKilowatt)
	ON_HMIBTN_ENTER(6, OnEnterBtnLoadValue)
///}}HMI_MSG
END_HMIMESSAGE_MAP()


//************窗口Load: 负荷监测*******************
CLcdWndLoad::~CLcdWndLoad()
{
}
CLcdWndLoad::CLcdWndLoad()
{
}
BOOL CLcdWndLoad::Init()
{
	SetClassName("CLcdWndLoad");
	SetCaption(tr("负荷监测"));
	SetEscWnd((CHmiWnd*)&(CLcdApp::m_WndMeasure));
	SetEnterWnd(NULL);
	SetUDFun(0);
	SetUDOffset(1);
	SetLRFun(0);
	SetLROffset(1);
	m_StaticImaxTime.SetPosition(16,24,211,44,0);
	m_StaticImaxTime.SetTabOrder(-4);
	m_pObjList[4] = &m_StaticImaxTime;
	m_StaticImaxTime.SetFont(16);
	m_StaticImaxTime.SetOwner(this);
	m_StaticImaxTime.SetCaption(tr("2010-01-01 12:23:23 888"));
	m_StaticImaxTime.SetDataSource(-1,0);
	m_StaticImaxTime.SetTimer(0);
	m_StaticImax.SetPosition(16,41,106,61,0);
	m_StaticImax.SetTabOrder(-5);
	m_pObjList[5] = &m_StaticImax;
	m_StaticImax.SetFont(16);
	m_StaticImax.SetOwner(this);
	m_StaticImax.SetCaption(tr("Imax=9999A"));
	m_StaticImax.SetDataSource(-1,0);
	m_StaticImax.SetTimer(0);
	m_StaticUval.SetPosition(124,41,214,61,0);
	m_StaticUval.SetTabOrder(-6);
	m_pObjList[6] = &m_StaticUval;
	m_StaticUval.SetFont(16);
	m_StaticUval.SetOwner(this);
	m_StaticUval.SetCaption(tr("U=27.5kV"));
	m_StaticUval.SetDataSource(-1,0);
	m_StaticUval.SetTimer(0);
	m_Static5384.SetPosition(10,75,220,90,0);
	m_Static5384.SetTabOrder(-7);
	m_pObjList[7] = &m_Static5384;
	m_Static5384.SetFont(16);
	m_Static5384.SetOwner(this);
	m_Static5384.SetCaption(tr("--------------------------"));
	m_Static5384.SetDataSource(-1,0);
	m_Static5384.SetTimer(0);
	m_StaticUminTime.SetPosition(16,85,211,105,0);
	m_StaticUminTime.SetTabOrder(-8);
	m_pObjList[8] = &m_StaticUminTime;
	m_StaticUminTime.SetFont(16);
	m_StaticUminTime.SetOwner(this);
	m_StaticUminTime.SetCaption(tr("2010-01-01 12:34:43 777"));
	m_StaticUminTime.SetDataSource(-1,0);
	m_StaticUminTime.SetTimer(0);
	m_StaticUmin.SetPosition(16,102,106,122,0);
	m_StaticUmin.SetTabOrder(-2);
	m_pObjList[2] = &m_StaticUmin;
	m_StaticUmin.SetFont(16);
	m_StaticUmin.SetOwner(this);
	m_StaticUmin.SetCaption(tr("Umin=24.5kV"));
	m_StaticUmin.SetDataSource(-1,0);
	m_StaticUmin.SetTimer(0);
	m_StaticIval.SetPosition(124,102,214,122,0);
	m_StaticIval.SetTabOrder(-3);
	m_pObjList[3] = &m_StaticIval;
	m_StaticIval.SetFont(16);
	m_StaticIval.SetOwner(this);
	m_StaticIval.SetCaption(tr("I=1234A"));
	m_StaticIval.SetDataSource(-1,0);
	m_StaticIval.SetTimer(0);
	m_Static5391.SetPosition(7,139,222,159,0);
	m_Static5391.SetTabOrder(-1);
	m_pObjList[1] = &m_Static5391;
	m_Static5391.SetFont(16);
	m_Static5391.SetOwner(this);
	m_Static5391.SetCaption(tr("按左右键可查看历史数据"));
	m_Static5391.SetDataSource(-1,0);
	m_Static5391.SetTimer(0);
	m_StaticAngleIM.SetPosition(16,59,106,79,0);
	m_StaticAngleIM.SetTabOrder(-9);
	m_pObjList[9] = &m_StaticAngleIM;
	m_StaticAngleIM.SetFont(16);
	m_StaticAngleIM.SetOwner(this);
	m_StaticAngleIM.SetCaption(tr("ΦI=0000°"));
	m_StaticAngleIM.SetDataSource(-1,0);
	m_StaticAngleIM.SetTimer(0);
	m_StaticAngleUM.SetPosition(124,59,214,79,0);
	m_StaticAngleUM.SetTabOrder(-10);
	m_pObjList[10] = &m_StaticAngleUM;
	m_StaticAngleUM.SetFont(16);
	m_StaticAngleUM.SetOwner(this);
	m_StaticAngleUM.SetCaption(tr("ΦU=0000°		"));
	m_StaticAngleUM.SetDataSource(-1,0);
	m_StaticAngleUM.SetTimer(0);
	m_StaticAngleUMin.SetPosition(16,120,106,140,0);
	m_StaticAngleUMin.SetTabOrder(-11);
	m_pObjList[11] = &m_StaticAngleUMin;
	m_StaticAngleUMin.SetFont(16);
	m_StaticAngleUMin.SetOwner(this);
	m_StaticAngleUMin.SetCaption(tr("ΦU=0000°"));
	m_StaticAngleUMin.SetDataSource(-1,0);
	m_StaticAngleUMin.SetTimer(0);
	m_StaticAngleIMin.SetPosition(124,120,214,140,0);
	m_StaticAngleIMin.SetTabOrder(-12);
	m_pObjList[12] = &m_StaticAngleIMin;
	m_StaticAngleIMin.SetFont(16);
	m_StaticAngleIMin.SetOwner(this);
	m_StaticAngleIMin.SetCaption(tr("ΦI=0000°"));
	m_StaticAngleIMin.SetDataSource(-1,0);
	m_StaticAngleIMin.SetTimer(0);
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(1);
	SetObjNum(12);
...
BEGIN_HMIMESSAGE_MAP(CLcdWndLoad,CHmiWnd)
//{{HMI_MSG_MAP(CLcdWndLoad)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndActionReport::Init()
{
	...
	SetLRFun(1);
	SetLROffset(1);
	m_ListActionReport.SetPosition(2,24,238,154,0);
...
BOOL CLcdWndAlarmReport::Init()
{
	...
	SetLRFun(1);
	SetLROffset(1);
	m_ListAlarmReport.SetPosition(2,25,238,150,0);
	m_ListAlarmReport.SetTabOrder(1);
	m_pObjList[1] = &m_ListAlarmReport;
	m_ListAlarmReport.SetFont(12);
...
BOOL CLcdWndOperationReport::Init()
{
	...
	SetLRFun(-1);
	SetLROffset(1);
	m_ListOperationReport.SetPosition(3,22,238,157,0);
	m_ListOperationReport.SetTabOrder(1);
	m_pObjList[1] = &m_ListOperationReport;
	m_ListOperationReport.SetFont(12);
...
BOOL CLcdWndSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnSettingQuery.SetPosition(11,28,226,53,0);
	...
	m_BtnsettingModify.SetPosition(11,61,226,86,0);
	...
	m_BtnSettingCopy.SetPosition(11,93,226,118,0);
	...
	m_BtnsettingExChg.SetPosition(11,126,226,151,0);
	...
	m_BtnASQuery.SetPosition(11,33,226,58,1);
	...
	m_BtnASModify.SetPosition(11,66,226,91,1);
...
BOOL CLcdWndSysSetting::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnAdress.SetPosition(17,28,217,53,0);
	...
	m_BtnInputSetting.SetPosition(17,61,217,86,0);
	...
	m_BtnBOTime.SetPosition(16,94,216,119,0);
	...
	m_BtnCI.SetPosition(17,127,217,152,0);
	m_BtnCI.SetTabOrder(4);
	m_pObjList[4] = &m_BtnCI;
	m_BtnCI.SetFont(16);
	m_BtnCI.SetOwner(this);
	m_BtnCI.SetCaption(tr("电度参数"));
	m_BtnCI.SetHaveEnterFun(FALSE);
	m_BtnCI.SetEnterWnd((CHmiWnd*)&(CLcdApp::m_WndCIPara));
	...
	m_BtnLanguage.SetPosition(17,63,217,88,1);
	...
	m_BtnPassSetting.SetPosition(17,96,217,121,1);
	...
	m_BtnSysParam.SetPosition(17,129,217,154,1);
...
BOOL CLcdWndCIPara::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnDIProperty.SetPosition(18,30,218,55,0);
	...
	m_BtnKWH.SetPosition(18,60,218,85,0);
	m_BtnKWH.SetTabOrder(2);
	m_pObjList[2] = &m_BtnKWH;
	m_BtnKWH.SetFont(16);
	m_BtnKWH.SetOwner(this);
	m_BtnKWH.SetCaption(tr("积分电度计算"));
	m_BtnKWH.SetHaveEnterFun(TRUE);
	m_BtnKWH.SetEnterWnd(NULL);
	m_BtnCIbase.SetPosition(18,91,218,116,0);
	...
	m_BtnPulseConst.SetPosition(18,122,218,147,0);
...
//{{HMI_MSG_MAP(CLcdWndCIPara)
	...
	ON_HMIBTN_ENTER(2, OnEnterBtnKWH)
...
BOOL CLcdWndfactorySet::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnManualCoef.SetPosition(26,30,206,55,0);
	...
	m_BtnAutoCoef.SetPosition(26,59,206,84,0);
...
BOOL CLcdWndTest::Init()
{
	...
	m_BtnLenTest.SetPosition(17,59,217,84,0);
	...
	m_BtnReportTest.SetPosition(17,92,217,117,0);
	...
	m_BtnManualREC.SetPosition(17,125,217,150,0);
	...
	m_Btnfactory.SetPosition(17,33,217,58,1);
	m_Btnfactory.SetTabOrder(5);
	m_pObjList[5] = &m_Btnfactory;
	m_Btnfactory.SetFont(16);
	m_Btnfactory.SetOwner(this);
	m_Btnfactory.SetCaption(tr("出厂设置"));
	m_Btnfactory.SetHaveEnterFun(TRUE);
	m_Btnfactory.SetEnterWnd((CHmiWnd*)&(CLcdApp::m_WndfactorySet));
	m_pObjList[0] = NULL;
	m_ppObjList = &(m_pObjList[1]);
	SetPageNum(2);
	SetObjNum(5);
...
//{{HMI_MSG_MAP(CLcdWndTest)
	ON_HMIBTN_ENTER(5, OnEnterBtnfactory)
///}}HMI_MSG
END_HMIMESSAGE_MAP()
...
BOOL CLcdWndOutputTest::Init()
{
	...
	m_EditOutputNum.SetValueRange(13,1);
...
BOOL CLcdWndsyspara::Init()
{
	...
	m_BtnFVDH.SetPosition(14,63,219,88,0);
	...
	m_BtnIRGBType.SetPosition(14,95,219,120,0);
	...
	m_BtnDefaultPara.SetPosition(14,126,219,151,0);
...
BOOL CLcdWndPortStatus::Init()
{
	...
	SetLRFun(0);
	SetLROffset(1);
	m_BtnPort.SetPosition(28,32,213,57,0);
	...
	m_BtnProtocol.SetPosition(28,66,213,91,0);
...
void CLcdApp::Init()
{
	...
	m_pWndList[2] = &m_WndLoad;
	m_pWndList[3] = &m_WndASModify;
	m_pWndList[4] = &m_WndASQuery;
	m_pWndList[5] = &m_WndReport;
	m_pWndList[6] = &m_WndActionReport;
	m_pWndList[7] = &m_WndAlarmReport;
	m_pWndList[8] = &m_WndStartReport;
	m_pWndList[9] = &m_WndOperationReport;
	m_pWndList[10] = &m_WndSettingQueryAreaNumInput;
	m_pWndList[11] = &m_WndSoeReport;
	m_pWndList[12] = &m_WndSetting;
	m_pWndList[13] = &m_WndconfigQury;
	m_pWndList[14] = &m_WndSettingQuery;
	m_pWndList[15] = &m_WndconfigModify;
	m_pWndList[16] = &m_WndSettingModify;
	m_pWndList[17] = &m_WndSettingSave;
	m_pWndList[18] = &m_WndSettingSwitch;
	m_pWndList[19] = &m_WndSettingCopy;
	m_pWndList[20] = &m_WndSoftSwitch;
	m_pWndList[21] = &m_WndSysSetting;
	m_pWndList[22] = &m_WndCIPara;
	m_pWndList[23] = &m_WndBOTime;
	m_pWndList[24] = &m_Wndtime;
	m_pWndList[25] = &m_WndInputSetting;
	m_pWndList[26] = &m_WndBIFilter;
	m_pWndList[27] = &m_WndBiNot;
	m_pWndList[28] = &m_WndSoeProperty;
	m_pWndList[29] = &m_WndCiBase;
	m_pWndList[30] = &m_WndPulseConst;
	m_pWndList[31] = &m_WndCF;
	m_pWndList[32] = &m_WndfactorySet;
	m_pWndList[33] = &m_WndTest;
	m_pWndList[34] = &m_WndManualREC;
	m_pWndList[35] = &m_WndOutputTest;
	m_pWndList[36] = &m_WndLanTest;
	m_pWndList[37] = &m_WndReportTest;
	m_pWndList[38] = &m_WndAddress;
	m_pWndList[39] = &m_WndEthadd;
	m_pWndList[40] = &m_WndCANAddress;
	m_pWndList[41] = &m_WndPassChange;
	m_pWndList[42] = &m_WndSettingChgAreaNumInput;
	m_pWndList[43] = &m_Wndsyspara;
	m_pWndList[44] = &m_WndSettingSwitchConfirm;
	m_pWndList[45] = &m_WndPortStatus;
	m_pWndList[46] = &m_WndWStatus;
