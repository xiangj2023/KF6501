...
public:
	...
	void OnEnterBtnPML();
	void OnEnterBtnLHarmonic();
	void OnEnterBtnKilowatt();
	void OnEnterBtnLoadValue();
	CHmiButton m_BtnHMeasure;
	CHmiButton m_BtnLMeasure;
	CHmiButton m_BtnPML;
	CHmiButton m_BtnLHarmonic;
	CHmiButton m_BtnKilowatt;
	CHmiButton m_BtnLoadValue;
...
///////////////////////////////////////////////
class CLcdWndLoad : public CHmiWnd
{
public:
	CLcdWndLoad();
	BOOL Init();
	virtual ~CLcdWndLoad();
	CHmiDataStatic m_StaticImaxTime;
	CHmiDataStatic m_StaticImax;
	CHmiDataStatic m_StaticUval;
	CHmiDataStatic m_Static5384;
	CHmiDataStatic m_StaticUminTime;
	CHmiDataStatic m_StaticUmin;
	CHmiDataStatic m_StaticIval;
	CHmiDataStatic m_Static5391;
	CHmiDataStatic m_StaticAngleIM;
	CHmiDataStatic m_StaticAngleUM;
	CHmiDataStatic m_StaticAngleUMin;
	CHmiDataStatic m_StaticAngleIMin;
	CHmiObj* m_pObjList[13];
	DECLARE_HMIMESSAGE_MAP() 
//{{begin of user function and memeber(CLcdWndLoad)
//手动添加的成员变量放在括号之间
public:
...
//}}end of user function and memeber(CLcdWndLoad)
};
