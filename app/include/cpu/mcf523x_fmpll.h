...
#define MCF_FMPLL_SYNCR    (*(DWORD*)(void*)(&__IPSBAR[0x120000]))
#define MCF_FMPLL_SYNSR    (*(DWORD*)(void*)(&__IPSBAR[0x120004]))
...
#define MCF_FMPLL_SYNCR_MFD(x)       (((x)&0x0000001F)<<24)
#define MCF_FMPLL_SYNCR_PREDIV(x)    (((x)&0x00000007)<<28)
