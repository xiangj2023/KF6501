...
#define MCF_PIT_PCSR0       (*(WORD*)(void*)(&__IPSBAR[0x150000]))
#define MCF_PIT_PMR0        (*(WORD*)(void*)(&__IPSBAR[0x150002]))
#define MCF_PIT_PCNTR0      (*(WORD*)(void*)(&__IPSBAR[0x150004]))
#define MCF_PIT_PCSR1       (*(WORD*)(void*)(&__IPSBAR[0x160000]))
#define MCF_PIT_PMR1        (*(WORD*)(void*)(&__IPSBAR[0x160002]))
#define MCF_PIT_PCNTR1      (*(WORD*)(void*)(&__IPSBAR[0x160004]))
#define MCF_PIT_PCSR2       (*(WORD*)(void*)(&__IPSBAR[0x170000]))
#define MCF_PIT_PMR2        (*(WORD*)(void*)(&__IPSBAR[0x170002]))
#define MCF_PIT_PCNTR2      (*(WORD*)(void*)(&__IPSBAR[0x170004]))
#define MCF_PIT_PCSR3       (*(WORD*)(void*)(&__IPSBAR[0x180000]))
#define MCF_PIT_PMR3        (*(WORD*)(void*)(&__IPSBAR[0x180002]))
#define MCF_PIT_PCNTR3      (*(WORD*)(void*)(&__IPSBAR[0x180004]))
#define MCF_PIT_PCSR(x)     (*(WORD*)(void*)(&__IPSBAR[0x150000+((x)*0x10000)]))
#define MCF_PIT_PMR(x)      (*(WORD*)(void*)(&__IPSBAR[0x150002+((x)*0x10000)]))
#define MCF_PIT_PCNTR(x)    (*(WORD*)(void*)(&__IPSBAR[0x150004+((x)*0x10000)]))
