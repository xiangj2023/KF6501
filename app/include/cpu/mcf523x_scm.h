...
#define MCF_SCM_IPSBAR     (*(DWORD*)(void*)(&__IPSBAR[0x000000]))
#define MCF_SCM_RAMBAR     (*(DWORD*)(void*)(&__IPSBAR[0x000008]))
#define MCF_SCM_CRSR       (*(BYTE *)(void*)(&__IPSBAR[0x000010]))
#define MCF_SCM_CWCR       (*(BYTE *)(void*)(&__IPSBAR[0x000011]))
#define MCF_SCM_LPICR      (*(BYTE *)(void*)(&__IPSBAR[0x000012]))
#define MCF_SCM_CWSR       (*(BYTE *)(void*)(&__IPSBAR[0x000013]))
#define MCF_SCM_DMAREQC    (*(DWORD*)(void*)(&__IPSBAR[0x000014]))
#define MCF_SCM_MPARK      (*(DWORD*)(void*)(&__IPSBAR[0x00001C]))
#define MCF_SCM_MPR        (*(BYTE *)(void*)(&__IPSBAR[0x000020]))
#define MCF_SCM_PACR0      (*(BYTE *)(void*)(&__IPSBAR[0x000024]))
#define MCF_SCM_PACR1      (*(BYTE *)(void*)(&__IPSBAR[0x000025]))
#define MCF_SCM_PACR2      (*(BYTE *)(void*)(&__IPSBAR[0x000026]))
#define MCF_SCM_PACR3      (*(BYTE *)(void*)(&__IPSBAR[0x000027]))
#define MCF_SCM_PACR4      (*(BYTE *)(void*)(&__IPSBAR[0x000028]))
#define MCF_SCM_PACR5      (*(BYTE *)(void*)(&__IPSBAR[0x00002A]))
#define MCF_SCM_PACR6      (*(BYTE *)(void*)(&__IPSBAR[0x00002B]))
#define MCF_SCM_PACR7      (*(BYTE *)(void*)(&__IPSBAR[0x00002C]))
#define MCF_SCM_PACR8      (*(BYTE *)(void*)(&__IPSBAR[0x00002E]))
#define MCF_SCM_GPACR0     (*(BYTE *)(void*)(&__IPSBAR[0x000030]))
