...
#define MCF_QSPI_QMR      (*(WORD*)(__IPSBAR+0x000340))
#define MCF_QSPI_QDLYR    (*(WORD*)(__IPSBAR+0x000344))
#define MCF_QSPI_QWR      (*(WORD*)(__IPSBAR+0x000348))
#define MCF_QSPI_QIR      (*(WORD*)(__IPSBAR+0x00034C))
#define MCF_QSPI_QAR      (*(WORD*)(__IPSBAR+0x000350))
#define MCF_QSPI_QDR      (*(WORD*)(__IPSBAR+0x000354))
