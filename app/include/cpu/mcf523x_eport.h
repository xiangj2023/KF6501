...
#define MCF_EPORT_EPPAR    (*(WORD*)(__IPSBAR+0x130000))
#define MCF_EPORT_EPDDR    (*(BYTE *)(__IPSBAR+0x130002))
#define MCF_EPORT_EPIER    (*(BYTE *)(__IPSBAR+0x130003))
#define MCF_EPORT_EPDR     (*(BYTE *)(__IPSBAR+0x130004))
#define MCF_EPORT_EPPDR    (*(BYTE *)(__IPSBAR+0x130005))
#define MCF_EPORT_EPFR     (*(BYTE *)(__IPSBAR+0x130006))
