...
#define MCF_I2C_I2AR     (*(BYTE *)(__IPSBAR+0x000300))
#define MCF_I2C_I2FDR    (*(BYTE *)(__IPSBAR+0x000304))
#define MCF_I2C_I2CR     (*(BYTE *)(__IPSBAR+0x000308))
#define MCF_I2C_I2SR     (*(BYTE *)(__IPSBAR+0x00030C))
#define MCF_I2C_I2DR     (*(BYTE *)(__IPSBAR+0x000310))
#define MCF_I2C_I2ICR    (*(BYTE *)(__IPSBAR+0x000320))
