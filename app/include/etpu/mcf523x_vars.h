...
uint32 fs_etpu_code_start =     0x401E0000;
uint32 fs_etpu_data_ram_start = 0x401D8000;
uint32 fs_etpu_data_ram_end =   0x401D85FC;
uint32 fs_etpu_data_ram_ext =   0x401DC000;
