...
*		kangqian	2011-03-22		直流保护去掉系数2
*									#include "resm5234.h"改为 #include "resmpc8315.h"
...
//@extern const LONG CFDefaultVal2[]; //系数2 kang 2011-3-22 15:21:42 直流保护不要系数2
